...
**Next:** `MODE=full` on nested KVM (`raynuvsrv1`) for Alpine kill/restart. Then iron NVMe (or USB) Force Off. Do not F11 this prototype. Do not start M8.1 TLS until that iron COM2 exists (design-only overlap is allowed).
