...
| Summary | Iron COM2 24c5fa6 wait-for-irq proved then PIT livelock; #229 one-shot PIT after first wake. Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. 3a wait-for-irq DONE; 3b ATA still missing. |
| Gates touched | Stage 46 OPEN (3a wait-for-irq done; 3b fail PIT livelock). Not Everest E5. |
| Months Δ | 0.5→0.5 |
...
| H9 | PR #231 IdeBus/SCI fork | LOW | **Parked** 2026-09-01 (ADR-015). Tip `8024439` stays parked. Close path #229 is dest_ok plus wait-for-irq (proved `24c5fa6`) plus one-shot PIT. Do not F11 `33555104832` / `33440050729`. Do not flash `8024439`. Do not OR PCI command `0x0001`. |
