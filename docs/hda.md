...
| Summary | Stage 46 OPEN hundred-twenty-sixth slice: linux unhandled nowait stop (iron 1a2544d past PAT/initrd then restore host xcr0; share hushes stop n=). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (linux unhandled nowait stop). Not Everest E5. |
| Months Δ | 0.5→0.5 |
