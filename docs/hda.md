...
| Summary | Iron COM2 5de9e1c HLT cf8en=0x80004008 (00:08.0+08 host) still ataio=0; #229 prints last IDE CF8. Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Last live BDF is host class, not IDE. |
| Gates touched | Stage 46 OPEN (ladder 3a DONE / 3b–3d FAIL / 3e IN PROGRESS). Not Everest E5. |
| Months Δ | 0.5→0.5 |
...
| H9 | PR #231 IdeBus/SCI fork | LOW | **Parked** 2026-09-01 (ADR-015). Tip `8024439` stays parked. COMMAND closed on iron COM2 `c144001` `pcicmd=0x5` still `ataio=0`. Iron COM2 `5de9e1c` HLT `cf8en=0x80004008` (`00:08.0+08` host) still `ataio=0`. Do not resume #231 for `COMMAND.IO`. Close path #229 prints last IDE CF8 (`cf8ide=`). Do not F11 `33575888121` / `33573126367` / `33571164257` / `33569757025` / `33567464001` / `33562028442` / `33559849096` / `33558261624` / `33555104832` / `33440050729`. Do not flash `8024439`. |
