...
| Summary | Stage 46 OPEN ninety-third slice: Linux CPUID hides hypervisor bit + 0x4000 scan after iron COM2 n=128 leaf=0x40003d00 / n=256 leaf=0x4000bd00. Firmware still reports KVM. Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (Linux hide hypervisor CPUID). Not Everest E5. |
| Months Δ | 0.5→0.5 |
