...
| Summary | Stage 46 OPEN ninety-seventh slice: HPET ~1ms step on non-HPET EPT so leftover-DRAM/MMIO storms do not freeze the counter after identify_cpu. Keeps CPUID/MSR 1ms and GRUB tsc=reliable. Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (HPET EPT insn step). Not Everest E5. |
| Months Δ | 0.5→0.5 |
