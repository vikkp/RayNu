...
| Gates touched | `usb_bot.rs` skip INQUIRY + `bot_cmd_retry` CAPACITY; host gate needle `Do not send START STOP or`; [m8_persist_iron.md](runbooks/m8_persist_iron.md). `./tools/sync-hda-site.sh --check`. |
