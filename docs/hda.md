...
| Summary | Stage 46 OPEN hundred-thirty-third slice: packed virtio common cfg write + LAPIC timer poll on Linux MMIO. Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (packed virtio common cfg write + virtio MMIO polls lapic). Not Everest E5. |
| Months Δ | 0.5→0.5 |
