...
|-------|-------|
| Commit | e5-ovmf-both |
| Summary | P0-58 OPEN host: OVMF-BOTH-OK simultaneous virtio 00:00.0 + IDE 00:00.1. Nested VT-x 105ffbe n=2048 rip=0x6e812d pci_ide=0 (10ms HPET); 1s step. Nested VT-x still required. Not installer. Iron P0-14 stays 2b795a0. |
