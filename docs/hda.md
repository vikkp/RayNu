...
| Summary | Stage 46 OPEN two-hundred-fifty-third slice: product ISO firmware wake preempt (HLT or VMX preemption 52; skip RIP stays HLT-only). CI 33456465331 VMXON-SKIP; F11 pin stays 33440050729 (do not re-flash). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (product ISO firmware wake preempt; F11 stays 33440050729). Not Everest E5. |
| Months Δ | 0.5→0.5 |
