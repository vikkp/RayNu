...
| Summary | Stage 46 OPEN hundred-fourteenth slice: linux earlycon share first CPUID (iron 9a3cbfa n=1 before #PF; iso=0 still must not latch). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (linux earlycon share first CPUID). Not Everest E5. |
| Months Δ | 0.5→0.5 |
