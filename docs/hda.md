...
| Summary | Stage 46 OPEN two-hundred-second slice: firmware HLT skip after ataio (PACKET HLT after ataio>0 still skips + Active; do not F11 90da03d). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (firmware HLT skip after ataio). Not Everest E5. |
| Months Δ | 0.5→0.5 |
