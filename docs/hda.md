...
| Summary | Stage 46 OPEN hundred-thirteenth slice: linux earlycon share product ISO + cpu_flush on tick cadence even when share (nested e0019a3/4f875d6 /init SIGSEGV after quiet ticks skipped CpuFlush; iso=0 must not latch share). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (linux earlycon share product ISO). Not Everest E5. |
| Months Δ | 0.5→0.5 |
