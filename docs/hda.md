...
| **Deploy Linux ISO** | ~99% | Live-ESP issue path armed; live E4 SHELL EPT not written; 4 MiB fixture not shipped OVMF.fd; VMLAUNCH insn not issued; distro later |
...
| Guest UEFI firmware blob | PARTIAL (live-issue) | Live-ESP VMLAUNCH issue path armed; live ESP bytes still absent; live E4 SHELL EPT not written; 4 MiB fixture not shipped OVMF.fd; VMLAUNCH insn not issued |
...
| Field | Value |
|-------|-------|
| Commit | e5-live-issue |
| Summary | P0-37 live-ESP VMLAUNCH issue path after private VMCS; live E4 SHELL EPT not written; 4 MiB fixture not shipped OVMF.fd; VMLAUNCH insn not issued. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Issue path armed ≠ live ESP bytes present ≠ live E4 SHELL EPT write ≠ shipped OVMF.fd ≠ VMLAUNCH insn ≠ installer. |
| Gates touched | `RAYNU-V-M7-E5-LIVE-ISSUE-OK` (host). Not Everest E5 / not `ISO-INSTALL-OK`. |
| Months Δ | 0.5→0.5 |
...
| H3 | No live guest UEFI CD | MED | Live-ESP issue path closed (P0-37); live ESP bytes still absent; live E4 SHELL EPT not written; 4 MiB fixture not shipped OVMF.fd; VMLAUNCH insn not issued; `attach_cdrom_uefi` still stub; extract-boot is lab MVP only |
