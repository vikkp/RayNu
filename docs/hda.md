...
| Gates touched | RayNu-F F3 CLOSED (nested). F4 media published on nested; guest `BLOCKIO-OK` awaited. F5c launch PROVEN (GRUB running); `FS-OK` awaited. F6-prep host-proven. F6 iron `ISO-INSTALL-OK` remains the only E5 close. |
| Months Δ | 0.5→0.5 |
