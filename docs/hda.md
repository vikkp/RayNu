...
| Summary | Stage 46 OPEN hundred-eleventh slice: linux earlycon quiet ticks + drain CHUNK so HV tick lines do not fill the shared TX ring (iron 202312f tick n=438272 interleaved e820; 9a3cbfa still printed ticks into the same FIFO as printk). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (linux earlycon quiet ticks). Not Everest E5. |
| Months Δ | 0.5→0.5 |
