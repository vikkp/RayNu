...
| Summary | Stage 46 OPEN hundred-eighty-second slice: firmware virtual-wire AEOI (OVMF IDT[0x20] EOIs LAPIC not PIC; eac424b would inject once then HLT forever). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (firmware virtual-wire AEOI). Not Everest E5. |
| Months Δ | 0.5→0.5 |
