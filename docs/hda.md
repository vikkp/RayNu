...
| Summary | Stage 46 OPEN seventy-seventh slice: leftover DRAM above PRECISE backs the 2GiB CMOS lie (report-RAM extra). Iron COM2 faeaf38 gzip+Loaded initrd (not ISO-INSTALL-OK). M4.3 stays CLOSED. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (report-RAM extra DRAM + lookup-or-map). Not Everest E5. |
| Months Δ | 0.5→0.5 |
