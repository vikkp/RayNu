...
| Summary | Stage 46 OPEN seventieth slice: port 0x61 TMR2_OUT toggle (OVMF in al,0x61; test al,0x20 after BdsDxe Start CD) + arm product ISO before disk attach (iron still 1MiB). Not ISO-INSTALL-OK. M4.3 stays CLOSED. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (PIT 0x61 + 256MiB disk). Not Everest E5. |
| Months Δ | 0.5→0.5 |
