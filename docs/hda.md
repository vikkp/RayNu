...
| Summary | Stage 46 OPEN three-hundred-eighteenth slice: nested iso=0 firmware IdeBus CLS RMW (CI 33531358763 VMXON ATAPI miss; 436df8d ilwr=0 intl=0 cls=0 ataio=0; QEMU pci_default_write_config walks CACHE_LINE_SIZE per-byte wmask 0xFF; Latency/header/BIST stay RO 0; dump clwr=; F11 pin stays 33440050729 do not re-flash; do not F11 436df8d). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (nested iso=0 firmware IdeBus CLS RMW; F11 stays 33440050729). Not Everest E5. |
| Months Δ | 0.5→0.5 |
