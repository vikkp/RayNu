...
| Summary | Stage 46 OPEN hundred-fifteenth slice: linux earlycon skip #PF dump on product-ISO Linux (iron 9a3cbfa dump shredded printk). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (linux earlycon skip #PF dump). Not Everest E5. |
| Months Δ | 0.5→0.5 |
