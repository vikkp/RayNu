...
| Summary | P0-59 OPEN host ATAPI-OK: 8-byte IDE BAR + diagnostic 0x90 after nested VT-x 80129d3 packet=0. Not installer. Iron P0-14 stays 2b795a0. |
...
| H3 | Guest UEFI CD not bootable | MED | Simultaneous virtio+IDE enum closed (P0-58); ATAPI `sectors>0` host-open (P0-59); nested VT-x `80129d3` still `packet=0`; firmware El Torito boot not completed; extract-boot is lab MVP only |
...
| 2026-08-23 | e5-ovmf-atapi | 0.5 | 95 | P0-59 OPEN 8-byte IDE BAR + 0x90 diagnostic + BMIDE BAR4 after nested VT-x 80129d3 packet=0 sectors=0; not installer; iron P0-14 stays 2b795a0 |
