...
| Summary | Stage 46 OPEN fifty-third slice: mount /dev/sr0 if virtio-iso vdb fails. Lab 73728 stub nested stays 65536. Not ISO-INSTALL-OK. M4.3 stays CLOSED. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (mount `/dev/sr0` if virtio-iso vdb fails). Not Everest E5. |
| Months Δ | 0.5→0.5 |
