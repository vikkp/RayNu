...
| Summary | Stage 46 OPEN sixty-sixth slice: MMIO skip-len from fetched bytes when VMCS insn_len is 0 (iron xAPIC n>0 len=0 hole). Not ISO-INSTALL-OK. M4.3 stays CLOSED. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (MMIO skip-len from fetched bytes). Not Everest E5. |
| Months Δ | 0.5→0.5 |
