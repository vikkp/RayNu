...
| Summary | Stage 46 OPEN hundred-eighty-first slice: firmware virtual-wire PIC (iron beb1576 HLT if=1 tpr=0x0 pic=0 gsi2=0; arm IRQ0 vec 0x20 on product-ISO HLT stall so raise_pit can take_pic_vector). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (firmware virtual-wire PIC). Not Everest E5. |
| Months Δ | 0.5→0.5 |
