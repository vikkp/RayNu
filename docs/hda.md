...
| Summary | Stage 46 OPEN hundred-ninth slice: guest UART TX ring drain 4/exit so nested QEMU is not 64-byte-blasted on every VM-exit (CI be0f1cd /init SIGSEGV 3/3). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (guest UART TX ring drain 4/exit). Not Everest E5. |
| Months Δ | 0.5→0.5 |
