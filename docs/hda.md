...
| Summary | Stage 46 OPEN hundred-thirty-first slice: packed virtio common cfg + PIT on Linux MMIO (iron deefa7c BAR trap ok=1, MMIO 0x14 x8, Freeing initrd then silent). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (packed virtio common cfg; virtio MMIO raises PIT). Not Everest E5. |
| Months Δ | 0.5→0.5 |
