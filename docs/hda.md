...
| Summary | Stage 46 OPEN ninety-fifth slice: alpine-virt GRUB linux line grows further into ISO9660 NUL pad for E4 tsc=reliable clocksource=tsc idle=poll (skip TSC vs frozen HPET calibrate after hypervisor-hide). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (Alpine GRUB E4 timer skip). Not Everest E5. |
| Months Δ | 0.5→0.5 |
