...
| Summary | Iron COM2 c8d504d ZeroMem ept fill never printed (0x34 is preempt not EPT) still ataio=0; #229 firmware WFE preempt skip. Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. ZeroMem EPT fill closed as diagnosis. |
| Gates touched | Stage 46 OPEN (ladder 3a DONE / 3b–3l FAIL / 3m IN PROGRESS). Not Everest E5. |
| Months Δ | 0.5→0.5 |
...
| H9 | PR #231 IdeBus/SCI fork | LOW | **Parked** 2026-09-01 (ADR-015). Tip `8024439` stays parked. COMMAND/CF8/ROM/hide-slot0/retaddr/ConIn/callsite/WFE-return/ZeroMem-EPT closed (`c8d504d` fill never printed; `0x34` is preempt). Do not resume #231 for `COMMAND.IO`. Close path #229 firmware WFE preempt skip. Do not F11 `33757018875` / `33753069821` / `33701350767` / `33699177232` / `33697154185` / `33695570769` / `33630723649` / `33627470674` / `33575888121` / `33573126367` / `33571164257` / `33569757025` / `33567464001` / `33562028442` / `33559849096` / `33558261624` / `33555104832` / `33440050729`. Do not flash `8024439`. |
