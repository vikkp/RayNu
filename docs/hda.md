...
| Summary | Iron COM2 27eda8c hide-slot0 (CDROM-OK via PIIX) still ataio=0; #229 prints HLT retaddr. Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. BAR conflict closed. |
| Gates touched | Stage 46 OPEN (ladder 3a DONE / 3b–3g FAIL / 3h IN PROGRESS). Not Everest E5. |
| Months Δ | 0.5→0.5 |
...
| H9 | PR #231 IdeBus/SCI fork | LOW | **Parked** 2026-09-01 (ADR-015). Tip `8024439` stays parked. COMMAND/CF8/ROM/hide-slot0 closed (`27eda8c` still `ataio=0`). Do not resume #231 for `COMMAND.IO`. Close path #229 prints HLT retaddr. Do not F11 `33695570769` / `33630723649` / `33627470674` / `33575888121` / `33573126367` / `33571164257` / `33569757025` / `33567464001` / `33562028442` / `33559849096` / `33558261624` / `33555104832` / `33440050729`. Do not flash `8024439`. |
