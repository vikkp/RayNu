...
| Summary | Stage 46 OPEN two-hundred-sixtieth slice: product ISO firmware IDE cmd I/O no inject (PCI command OUT does not inject; ATA 0x76 waits for CpuSleep). CI 33461311226 VMXON-SKIP; F11 pin stays 33440050729 (do not re-flash). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (product ISO firmware IDE cmd I/O no inject; F11 stays 33440050729). Not Everest E5. |
| Months Δ | 0.5→0.5 |
