...
| Summary | Stage 46 OPEN two-hundred-fortieth slice: nested iso=0 firmware LAPIC timer (CI 33444677681 VMXON-SKIP; 33440951898 pic=0 gsi2=0 APIC-mode CpuSleep; product skip_pit / wait_for_irq unchanged; F11 pin stays 33440050729). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (nested iso=0 firmware LAPIC timer; F11 stays 33440050729). Not Everest E5. |
| Months Δ | 0.5→0.5 |
