...
| Summary | Stage 46 OPEN two-hundred-fifty-first slice: product ISO firmware HLT wake LVT unmask (inject 0x20 with force LVT expiry so CpuSleep does not re-sleep on masked 0xEF). CI 33455373334 VMXON-SKIP; F11 pin stays 33440050729 (do not re-flash). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (product ISO firmware HLT wake LVT unmask; F11 stays 33440050729). Not Everest E5. |
| Months Δ | 0.5→0.5 |
