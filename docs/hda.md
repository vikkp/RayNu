...
| Summary | Stage 46 OPEN hundred-twenty-fifth slice: cpu_flush leftover per walk (iron abfb008 skip n=944 then tick n=256 hung on 64 heap slots). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (cpu_flush leftover per walk). Not Everest E5. |
| Months Δ | 0.5→0.5 |
