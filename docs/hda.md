...
| Summary | Stage 46 OPEN hundred-twelfth slice: linux earlycon hush HV so write_byte drops during share (iron 9a3cbfa linux cpuid n=2/n=3 shredded Linux version / cmdline). ISO-INSTALL-OK uses write_line_nowait. Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (linux earlycon hush HV). Not Everest E5. |
| Months Δ | 0.5→0.5 |
