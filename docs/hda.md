...
| Summary | P0-59 OPEN host ATAPI-OK: signature + PACKET interrupt-reason; stop on sectors>0 not both-enum-alone. Nested VT-x pending. Not installer. Iron P0-14 stays 2b795a0. |
...
| H3 | Guest UEFI CD not bootable | MED | Simultaneous virtio+IDE enum closed (P0-58); ATAPI `sectors>0` host-open (P0-59); firmware El Torito boot not completed; extract-boot is lab MVP only |
...
| 2026-08-23 | e5-ovmf-atapi | 0.5 | 95 | P0-59 OPEN host ATAPI-OK signature+PACKET; stop on sectors>0 not both-enum-alone; nested VT-x pending; not installer; iron P0-14 stays 2b795a0 |
