...
| H9 | PR #231 IdeBus/SCI fork | LOW | **Parked** 2026-09-01 (ADR-015). Tip `8024439` stays parked. COMMAND closed on iron COM2 `c144001` `pcicmd=0x5` still `ataio=0`. Do not resume #231 for `COMMAND.IO`. Close path #229 prints last CF8 on HLT. Do not F11 `33571164257` / `33569757025` / `33567464001` / `33562028442` / `33559849096` / `33558261624` / `33555104832` / `33440050729`. Do not flash `8024439`. |
