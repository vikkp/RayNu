...
| Summary | Retrigger b0a3356 cf8en= after nested ATAPI miss (33575225212 7/7). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
...
| H9 | PR #231 IdeBus/SCI fork | LOW | **Parked** 2026-09-01 (ADR-015). Tip `8024439` stays parked. COMMAND closed on iron COM2 `c144001` `pcicmd=0x5` still `ataio=0`. Iron COM2 `61991be` HLT `cf8=0x0` still `ataio=0`. Do not resume #231 for `COMMAND.IO`. Close path #229 prints last enabled CF8 (`cf8en=`). Do not F11 `33573126367` / `33571164257` / `33569757025` / `33567464001` / `33562028442` / `33559849096` / `33558261624` / `33555104832` / `33440050729`. Do not flash `8024439`. |
