...
| Summary | Stage 46 OPEN hundred-fortieth slice: product ISO fw_cfg ACPI MADT (iso=0 named files stay 3). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (product ISO fw_cfg ACPI MADT). Not Everest E5. |
| Months Δ | 0.5→0.5 |
