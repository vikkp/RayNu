...
|-------|-------|
| Commit | e5-ovmf-both |
| Summary | P0-58 OPEN host: OVMF-BOTH-OK simultaneous virtio 00:00.0 + IDE 00:00.1. PIIX4 PM 00:01.3 + guest-private i440FX DID remap after nested VT-x 699c9a6 n=2048 pci_ide=0 (AcpiTimerLib rejects DID 0x1042). HLT skip + CR-access resume. Nested VT-x still required. Not installer. Iron P0-14 stays 2b795a0. |
