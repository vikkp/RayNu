...
last_commit: 199569006f93eb77bf34bb2c9f598ca829661794
last_commit_short: 1995690
updated_by: cursor
...
| **Confidence** | medium | E2+E3+E5 on COM2; Phase 0 **closed** (`14e4:165f`); Phase C QEMU GET / closed; E3b iron (Phase D driver) open |
...
| **Post-EBS durable HTTP (E3b)** | MISSING | Phase 0 **closed on iron** (`14e4:165f` BCM5720 @ `01:00.0`); Phase C **QEMU GET /** closed; iron `HOST-NIC-HTTP-OK` waits on Phase D driver |
...
| P0-12 | **M7.8 / E3b** Host-owned mgmt NIC (ADR-013) | C | 1.0 | P0-4 | Phase 0 **closed** (`14e4:165f`); Phase C QEMU GET / **closed**; Phase D Device for that id **open** |
...
| Field | Value |
|-------|-------|
| Commit | PENDING (pin after evidence commit) |
| Summary | ADR-013 Phase 0 **closed on iron** — R640 COM2 census `14e4:165f` BCM5720 |
| Everest impact | months 1.5 held; ETA 2026-10; overall 88 held; E3b still open (Phase D driver) |
| Gates touched | Phase 0 closed; `HOST-NIC-HTTP-OK` not claimed |
| Months Δ | 1.5 held |
...
| H4 | Firmware SNP unusable after EBS | HIGH | **Phase A closed**; Phase C QEMU GET / closed; Phase 0 **closed** (`14e4:165f`); E3b iron = Phase D Device for that id |
...
Now:           E2+E3+E5 stamps CLOSED; Phase 0 CLOSED (`14e4:165f`); E3b OPEN
Months left:   1.5  (ETA ~ 2026-10)
Next move:     Phase D Device for 14e4:165f @ 01:00.0; no SNP after EBS
