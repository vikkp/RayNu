...
| Summary | P0-59 OPEN 8192-exit cap after nested VT-x 8e55abf ata=0 unh=0 still PciBus. Not installer. Iron P0-14 stays 2b795a0. |
...
| H3 | Guest UEFI CD not bootable | MED | Simultaneous virtio+IDE enum closed (P0-58); ATAPI `sectors>0` host-open (P0-59); nested VT-x `8e55abf` still PciBus `ata=0`; firmware El Torito boot not completed; extract-boot is lab MVP only |
...
| 2026-08-23 | e5-ovmf-atapi | 0.5 | 95 | P0-59 OPEN 8192-exit cap after nested VT-x 8e55abf ata=0 unh=0 port=cf8 still PciBus; not installer; iron P0-14 stays 2b795a0 |
