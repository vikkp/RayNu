...
| Summary | Stage 46 OPEN three-hundred-twentieth slice: nested iso=0 firmware IdeBus cfg read (CI 33535050708 VMXON-SKIP; b6e8ab7 cfg RAM RMW unproven; QEMU pci_default_read_config memcpy from config+addr for len, not an aligned-dword shift; dump cfgo=; F11 pin stays 33440050729 do not re-flash; do not F11 b6e8ab7). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (nested iso=0 firmware IdeBus cfg read; F11 stays 33440050729). Not Everest E5. |
| Months Δ | 0.5→0.5 |
...
| 2026-09-01 | e5-stage46-iso | 0.5 | 95 | Stage 46 OPEN three-hundred-twentieth slice: nested iso=0 firmware IdeBus cfg read (CI 33535050708 VMXON-SKIP; b6e8ab7 cfg RAM RMW unproven; QEMU pci_default_read_config memcpy from config+addr; dump cfgo=; F11 pin stays 33440050729 do not re-flash; do not F11 b6e8ab7); not ISO-INSTALL-OK; iron P0-14 stays 2b795a0 |
| 2026-09-01 | e5-stage46-iso | 0.5 | 95 | Stage 46 OPEN three-hundred-nineteenth slice: nested iso=0 firmware IdeBus cfg RAM RMW (CI 33533510182 VMXON-SKIP; 1465367 CLS RMW unproven; QEMU pci_default_write_config 0x40-0xFF per-byte spanning dwords; dump c40w=; F11 pin stays 33440050729 do not re-flash; do not F11 1465367); not ISO-INSTALL-OK; iron P0-14 stays 2b795a0 |
| 2026-09-01 | e5-stage46-iso | 0.5 | 95 | Stage 46 OPEN three-hundred-eighteenth slice: nested iso=0 firmware IdeBus CLS RMW (CI 33531358763 VMXON ATAPI miss; 436df8d ilwr=0 intl=0 cls=0 ataio=0; QEMU pci_default_write_config CACHE_LINE_SIZE per-byte wmask 0xFF; dump clwr=; F11 pin stays 33440050729 do not re-flash; do not F11 436df8d); not ISO-INSTALL-OK; iron P0-14 stays 2b795a0 |
| 2026-09-01 | e5-stage46-iso | 0.5 | 95 | Stage 46 OPEN three-hundred-seventeenth slice: nested iso=0 firmware IdeBus INTLINE RMW (CI 33528635379 VMXON-SKIP; eeaa681 cmd status unproven; QEMU pci_default_write_config INTERRUPT_LINE per-byte wmask 0xFF; dump ilwr=; F11 pin stays 33440050729 do not re-flash; do not F11 eeaa681); not ISO-INSTALL-OK; iron P0-14 stays 2b795a0 |
...
| 2026-09-01 | e5-stage46-iso | 0.5 | 95 | Stage 46 OPEN three-hundred-eleventh slice: nested iso=0 firmware IdeBus PCI cfg RAM (CI 33515762670 VMXON-SKIP; 1e95a93 LT RO unproven; QEMU pci_init_wmask is 0xff from 0x40 through 0xFF, live RAZ of 0x44+ dropped SIDETIM/UDMA readback; dump cfg44=; F11 pin stays 33440050729 do not re-flash; do not F11 1e95a93); not ISO-INSTALL-OK; iron P0-14 stays 2b795a0 |
...
| 2026-09-01 | e5-stage46-iso | 0.5 | 95 | Stage 46 OPEN two-hundred-ninety-ninth slice: nested iso=0 firmware IdeBus secondary absent (CI 33500735336 VMXON-SKIP; 8b6b36a secondary empty unproven; QEMU ide_init_ioport decodes secondary; empty units read status 0x00 not floating 0xFF and not ATAPI 0x50; F11 pin stays 33440050729 do not re-flash); not ISO-INSTALL-OK; iron P0-14 stays 2b795a0 |
| 2026-09-01 | e5-stage46-iso | 0.5 | 95 | Stage 46 OPEN two-hundred-ninety-eighth slice: nested iso=0 firmware IdeBus secondary empty (CI 33499455958 VMXON-SKIP; af80d50 BMIDE IO unproven; QEMU CD is primary master only; 0x170/0x376 floating 0xFF; unimplemented BAR0-3 do not steal ports 0-7; F11 pin stays 33440050729 do not re-flash); not ISO-INSTALL-OK; iron P0-14 stays 2b795a0 |
| 2026-09-01 | e5-stage46-iso | 0.5 | 95 | Stage 46 OPEN two-hundred-ninety-seventh slice: nested iso=0 firmware IdeBus BMIDE IO (CI 33498693991 VMXON-SKIP; b9e4b81 INTPIN unproven; QEMU pci_register_bar decodes BAR4 I/O only when COMMAND.IO is set; F11 pin stays 33440050729 do not re-flash); not ISO-INSTALL-OK; iron P0-14 stays 2b795a0 |
| 2026-09-01 | e5-stage46-iso | 0.5 | 95 | Stage 46 OPEN two-hundred-ninety-sixth slice: nested iso=0 firmware IdeBus INTPIN (CI 33497723127 VMXON-SKIP; 8344896 BMIDE unproven; QEMU PIIX3 IDE interrupt pin 0 so PciBus does not allocate PIRQ 0x80 before EnableAttributes / ISA 0x3F6; F11 pin stays 33440050729 do not re-flash); not ISO-INSTALL-OK; iron P0-14 stays 2b795a0 |
...
| 2026-09-01 | e5-stage46-iso | 0.5 | 95 | Stage 46 OPEN two-hundred-eighty-seventh slice: nested iso=0 firmware IdeBus ConnectAll trail (CI 33486901066 VMXON pcicmd=0x0 cmdn=3 cmdwr=0x0 bar4=0xcc01 ataio=0; 291b539 ConnectAll first regression vs f3761c4 pcicmd=0x1; trail OFW Pci(1,1) again; BAR4 stays 0xCC01; F11 pin stays 33440050729 do not re-flash); not ISO-INSTALL-OK; iron P0-14 stays 2b795a0 |
...
| 2026-09-01 | e5-stage46-iso | 0.5 | 95 | Stage 46 OPEN two-hundred-sixty-seventh slice: product ISO firmware HLT EDK2 0x68 (iron ea30da1 leftover 0x20 timer ISR; CI 33466397855 nested 0x68 VMXON-SKIP; F11 pin stays 33440050729 do not re-flash); not ISO-INSTALL-OK; iron P0-14 stays 2b795a0 |
...
| 2026-09-01 | e5-stage46-iso | 0.5 | 95 | Stage 46 OPEN two-hundred-sixty-third slice: product ISO firmware Delay I/O no inject (PM timer IN already ticks; inject 0x20 on CpuSleep HLT not Delay I/O; CI 33462988233 VMXON-SKIP; F11 pin stays 33440050729 do not re-flash); not ISO-INSTALL-OK; iron P0-14 stays 2b795a0 |
...
| 2026-09-01 | e5-stage46-iso | 0.5 | 95 | Stage 46 OPEN two-hundred-fifty-first slice: product ISO firmware HLT wake LVT unmask (inject 0x20 with force LVT expiry; CI 33455373334 VMXON-SKIP; F11 pin stays 33440050729 do not re-flash); not ISO-INSTALL-OK; iron P0-14 stays 2b795a0 |
...
| 2026-08-31 | e5-stage46-iso | 0.5 | 95 | Stage 46 OPEN two-hundred-forty-second slice: nested iso=0 firmware HLT ATA (IDENTIFY WaitForInterrupt IRQ 14 via shadow 8259 0x76) plus firmware SRST ATA IRQ (product SRST deassert); CI 33446918467 VMXON-SKIP; F11 pin stays 33440050729; not ISO-INSTALL-OK; iron P0-14 stays 2b795a0 |
| 2026-08-31 | e5-stage46-iso | 0.5 | 95 | Stage 46 OPEN two-hundred-forty-first slice: product ISO firmware HLT wake (EDK2 0x68 on firmware HLT ataio==0; skip_pit leftover 0x20/0xEF; wait_for_irq stays false; CI 33445476540 VMXON-SKIP; F11 pin stays 33440050729); not ISO-INSTALL-OK; iron P0-14 stays 2b795a0 |
| 2026-08-31 | e5-stage46-iso | 0.5 | 95 | Stage 46 OPEN two-hundred-fortieth slice: nested iso=0 firmware LAPIC timer (CI 33444677681 VMXON-SKIP; 33440951898 pic=0 gsi2=0 APIC-mode CpuSleep; product skip_pit / wait_for_irq unchanged; F11 pin stays 33440050729); not ISO-INSTALL-OK; iron P0-14 stays 2b795a0 |
| 2026-08-31 | e5-stage46-iso | 0.5 | 95 | Stage 46 OPEN two-hundred-thirty-ninth slice: nested iso=0 EDK2 IRQ0 (CI 33443188019 VMXON-SKIP; PIC take-None injects 0x68; product skip_pit / wait_for_irq unchanged; F11 pin stays 33440050729); not ISO-INSTALL-OK; iron P0-14 stays 2b795a0 |
| 2026-08-31 | e5-stage46-iso | 0.5 | 95 | Stage 46 OPEN two-hundred-thirty-eighth slice: nested iso=0 firmware HLT PIT (CI 33440951898 skip-without-inject ataio=0; product skip_pit / wait_for_irq unchanged; F11 pin stays 33440050729); not ISO-INSTALL-OK; iron P0-14 stays 2b795a0 |
| 2026-08-31 | e5-stage46-iso | 0.5 | 95 | Stage 46 OPEN two-hundred-thirty-seventh slice: flash b5c3a9c pin 33440050729 (firmware HLT insn_len 0 skip CI green; EFI 9775891845; do not F11 a14223f / --run 33436232227); not ISO-INSTALL-OK; iron P0-14 stays 2b795a0 |
