...
| Summary | Iron COM2 7ba1ccf HLT cf8ide=0x80000930 (00:01.1+30 ROM) still ataio=0; #229 prints last IDE ROM write. Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Last IDE CF8 is Expansion ROM, not COMMAND/I/O BAR. |
| Gates touched | Stage 46 OPEN (ladder 3a DONE / 3b–3e FAIL / 3f IN PROGRESS). Not Everest E5. |
| Months Δ | 0.5→0.5 |
...
| H9 | PR #231 IdeBus/SCI fork | LOW | **Parked** 2026-09-01 (ADR-015). Tip `8024439` stays parked. COMMAND closed on iron COM2 `c144001` `pcicmd=0x5` still `ataio=0`. Iron COM2 `7ba1ccf` HLT `cf8ide=0x80000930` (`00:01.1+30` ROM) still `ataio=0`. Do not resume #231 for `COMMAND.IO`. Close path #229 prints last IDE ROM write (`romwr=`). Do not F11 `33627470674` / `33575888121` / `33573126367` / `33571164257` / `33569757025` / `33567464001` / `33562028442` / `33559849096` / `33558261624` / `33555104832` / `33440050729`. Do not flash `8024439`. |
