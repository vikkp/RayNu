...
| Summary | Iron COM2 184ee61 cmdwr=6 wr=0x0 pcicmd=0x1 (OR hid disable). Next honors COMMAND as written. Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Iron wrote COMMAND; last write disable. |
| Gates touched | Stage 46 OPEN (3a skip-HLT done; cmdwr printed; 3b fail same hang). Not Everest E5. |
| Months Δ | 0.5→0.5 |
...
| H9 | PR #231 IdeBus/SCI fork | LOW | **Parked** 2026-09-01 (ADR-015). Tip `8024439` stays parked. Close path #229 iron COM2 `184ee61` wrote IDE COMMAND (`cmdwr=6` last `wr=0x0` stored `0x1`). Next honors COMMAND (no OR `0x0001`). Do not F11 `33562028442` / `33559849096` / `33558261624` / `33555104832` / `33440050729`. Do not flash `8024439`. |
