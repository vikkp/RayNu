...
| **Confidence** | medium | E2+E3+E5 on COM2; E3b = ADR-013 Accepted; Phase C QEMU e1000 in progress |
...
| **Post-EBS durable HTTP (E3b)** | MISSING | ADR-013 **Accepted**; Phase A WARN-only closed on iron; Phase C QEMU e1000 (M7.8) in progress |
...
| M+2 | 2026-09 | E3b native NIC lab (QEMU e1000) + ISO residual | ADR-013 Phase C | **IN PROGRESS** |
...
| P0-12 | **M7.8 / E3b** Host-owned mgmt NIC (ADR-013) | C | 1.0 | P0-4 | **Accepted**; Phase A closed on iron; Phase C QEMU e1000 in progress |
...
| Field | Value |
|-------|-------|
| Commit | M7.8 Phase C: QEMU e1000 Device + bounded poll + post-EBS listen |
| Summary | Native e1000 path wired; QEMU GET / lab in this PR; iron HTTP-OK not claimed |
| Everest impact | months 1.5 held; ETA 2026-10; overall 88 held; E3b still open |
| Gates touched | `HOST-NIC-SCAFFOLD-OK`; `HOST-NIC-QEMU-OK` is firmware lab; `HOST-NIC-HTTP-OK` not claimed |
| Months Δ | 1.5 held |
...
| H4 | Firmware SNP unusable after EBS | HIGH | **Phase A closed** (WARN-only, no RSOD); E3b = ADR-013 Accepted; Phase C QEMU e1000 in progress |
...
|------|--------|-------:|----------:|------|
| 2026-08-17 | m7-8-host-nic-c | 1.5 | 88 | Phase C started: QEMU e1000 Device + bounded poll; iron HTTP-OK open |
...
Next move:     Phase C QEMU e1000 post-EBS GET / (M7.8); no SNP after EBS
