...
| Summary | Stage 46 OPEN three-hundred-nineteenth slice: nested iso=0 firmware IdeBus cfg RAM RMW (CI 33533510182 VMXON-SKIP; 1465367 CLS RMW unproven; QEMU pci_default_write_config walks 0x40-0xFF per-byte wmask 0xFF including dword-spanning writes; dump c40w=; F11 pin stays 33440050729 do not re-flash; do not F11 1465367). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (nested iso=0 firmware IdeBus cfg RAM RMW; F11 stays 33440050729). Not Everest E5. |
| Months Δ | 0.5→0.5 |
