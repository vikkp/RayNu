...
| Summary | Stage 46 OPEN hundred-fifth slice: Linux printk ticks every 4096 after #PF deliver so COM2 can show smpboot/pci/virtio (iron 115e5ee every-256 UART split PAT). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (Linux printk ticks every 4096). Not Everest E5. |
| Months Δ | 0.5→0.5 |
