...
| Summary | Stage 46 OPEN hundred-thirtieth slice: virtio BAR trap over scratch + PIIX3 ISA BAR RAZ (iron df0c118 Freeing initrd then silent). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (virtio BAR trap over scratch). Not Everest E5. |
| Months Δ | 0.5→0.5 |
