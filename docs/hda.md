...
| Summary | Stage 46 OPEN hundred-eighty-third slice: firmware virtual-wire GSI 2 + HLT force IF (iron eac424b pic=1 then 6 sparse vec=0x20 CR8 CpuSleep ataio=0). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (firmware virtual-wire GSI 2). Not Everest E5. |
| Months Δ | 0.5→0.5 |
