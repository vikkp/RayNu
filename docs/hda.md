...
| Summary | Stage 46 OPEN two-hundred-twenty-fourth slice: firmware PIC ATA (take PIC 0x2E when the 8259 can deliver it; F11 pin stays 33424573770 until this CI). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (firmware PIC ATA). Not Everest E5. |
| Months Δ | 0.5→0.5 |
