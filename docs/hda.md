...
| Summary | Stage 46 OPEN ninety-eighth slice: bump alpine-virt grub.cfg ISO9660+Joliet Data Length 143→208 so the linux-line NUL-pad grow is visible to GRUB (iron COM2 truncated at tsc= → rescue grub>). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (GRUB.cfg Data Length). Not Everest E5. |
| Months Δ | 0.5→0.5 |
