...
| Summary | Stage 46 OPEN hundred-tenth slice: linux earlycon share TX ring so HV ticks / hypervisor-scan bump enqueue after Linux #PF (iron 202312f readable Linux version then e820 cut). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (linux earlycon share TX ring). Not Everest E5. |
| Months Δ | 0.5→0.5 |
