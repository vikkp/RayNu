...
| Summary | Stage 46 OPEN two-hundred-sixth slice: firmware force IF for inject (PACKET nIEN=0 after ataio>0 still needs IF; do not F11 77f5866). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (firmware force IF for inject). Not Everest E5. |
| Months Δ | 0.5→0.5 |
