...
| Summary | Stage 46 OPEN ninety-sixth slice: HPET ~1ms step on CPUID/RDMSR/WRMSR so identify_cpu does not freeze the counter (iron 0x4000 walk). Keeps GRUB tsc=reliable. Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (HPET insn step). Not Everest E5. |
| Months Δ | 0.5→0.5 |
