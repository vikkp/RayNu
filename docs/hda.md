...
| Summary | Stage 46 OPEN two-hundred-forty-first slice: product ISO firmware HLT wake (EDK2 0x68 on firmware HLT ataio==0; skip_pit leftover 0x20/0xEF; wait_for_irq stays false; CI 33445476540 VMXON-SKIP; F11 pin stays 33440050729). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (product ISO firmware HLT wake; F11 stays 33440050729). Not Everest E5. |
| Months Δ | 0.5→0.5 |
