...
| Summary | Stage 46 OPEN hundred-thirty-sixth slice: PIT prefer until virtio DRIVER_OK so UART is not starved. Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (linux PIT prefer until DRIVER_OK). Not Everest E5. |
| Months Δ | 0.5→0.5 |
