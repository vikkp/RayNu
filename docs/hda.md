...
| Summary | Stage 46 OPEN seventy-second slice: ISO serial patches only in ASCII cfg (iron EFI stub uncompression error after Linux virt); 64MiB disk leave + TMR2_OUT still in this EFI. Not ISO-INSTALL-OK. M4.3 stays CLOSED. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (ASCII ISO patch + disk leave). Not Everest E5. |
| Months Δ | 0.5→0.5 |
