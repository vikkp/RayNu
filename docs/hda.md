...
| Summary | Stage 46 OPEN ninety-second slice: delay_loop skip-10 to ret + RAX=1 so outer dec/jnz does not re-enter. Nested f1afc27 after leftover+#PF. Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (Linux delay_loop skip-to-ret). Not Everest E5. |
| Months Δ | 0.5→0.5 |
