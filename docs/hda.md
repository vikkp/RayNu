...
| Summary | Stage 46 OPEN two-hundred-fifty-second slice: product ISO firmware LVT timer inject (skip_pit must not drop periodic LVT 0x20 after unmask). CI 33455903058 VMXON-SKIP; F11 pin stays 33440050729 (do not re-flash). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (product ISO firmware LVT timer inject; F11 stays 33440050729). Not Everest E5. |
| Months Δ | 0.5→0.5 |
