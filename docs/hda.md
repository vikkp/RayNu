...
| Summary | Stage 46 OPEN hundred-seventh slice: Linux CPUID GenuineIntel + NX and EFER NXE after high-half (iron 45aec97 GenuineIntEl / NX missing then PAT). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (Linux CPUID GenuineIntel + NX; EFER NXE after high-half). Not Everest E5. |
| Months Δ | 0.5→0.5 |
