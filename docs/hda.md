...
| Summary | Iron COM2 d0e44d4 WFE skip len=12 rip=0x7ff0e7e8 still ataio=0 (mov rax,3); #229 firmware WFE state4 poke. Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. RIP skip of cmp [rip],4 closed. |
| Gates touched | Stage 46 OPEN (ladder 3a DONE / 3b–3m FAIL / 3n IN PROGRESS). Not Everest E5. |
| Months Δ | 0.5→0.5 |
