...
| Summary | Stage 46 OPEN two-hundred-sixty-eighth slice: nested iso=0 firmware HLT 0x68 miss + firmware HLT inject cap (CI 33466890874 VMXON inject vec=0x68 CR livelock ataio=0; F11 pin stays 33440050729 do not re-flash). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (nested iso=0 firmware HLT 0x68 miss; firmware HLT inject cap; F11 stays 33440050729). Not Everest E5. |
| Months Δ | 0.5→0.5 |
