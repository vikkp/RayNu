...
| Summary | Iron COM2 2d4ab51 HLT ret=0x7ff0e055 (DxeCore Wait) still ataio=0; #229 firmware ConIn CR. Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Caller named (DxeCore). |
| Gates touched | Stage 46 OPEN (ladder 3a DONE / 3b–3h FAIL / 3i IN PROGRESS). Not Everest E5. |
| Months Δ | 0.5→0.5 |
...
| H9 | PR #231 IdeBus/SCI fork | LOW | **Parked** 2026-09-01 (ADR-015). Tip `8024439` stays parked. COMMAND/CF8/ROM/hide-slot0/retaddr closed (`2d4ab51` `ret=0x7ff0e055` still `ataio=0`). Do not resume #231 for `COMMAND.IO`. Close path #229 firmware ConIn CR. Do not F11 `33697154185` / `33695570769` / `33630723649` / `33627470674` / `33575888121` / `33573126367` / `33571164257` / `33569757025` / `33567464001` / `33562028442` / `33559849096` / `33558261624` / `33555104832` / `33440050729`. Do not flash `8024439`. |
