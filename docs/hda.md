...
| Summary | Iron COM2 060c504 seq=0,0,0,0,0,0. Next EnableAttributes 0x0005 after write-0. Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. COMMAND writes are disable-only. |
| Gates touched | Stage 46 OPEN (seq proved all zero; 3b fail same hang). Not Everest E5. |
| Months Δ | 0.5→0.5 |
...
| H9 | PR #231 IdeBus/SCI fork | LOW | **Parked** 2026-09-01 (ADR-015). Tip `8024439` stays parked. Close path #229 iron COM2 `060c504` `seq=0,0,0,0,0,0`. Next EnableAttributes `0x0005` after write-0. Do not F11 `33569757025` / `33567464001` / `33562028442` / `33559849096` / `33558261624` / `33555104832` / `33440050729`. Do not flash `8024439`. |
