...
| Summary | Stage 46 OPEN hundredth slice: alpine-virt native_cpuid push %rbx RSP slot (base in EBX; c73970d GPR bump misses). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (native_cpuid push-rbx RSP slot). Not Everest E5. |
| Months Δ | 0.5→0.5 |
