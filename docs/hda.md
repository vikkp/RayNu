...
| Summary | Stage 46 OPEN hundred-sixth slice: guest UART nowait (do not clear COM2_LIVE on THR timeout) so a PAT `out` cannot freeze iDRAC SOL (iron 115e5ee n=441600). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (guest UART nowait; do not clear COM2_LIVE). Not Everest E5. |
| Months Δ | 0.5→0.5 |
