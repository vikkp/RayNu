...
| Summary | Stage 46 OPEN ninety-ninth slice: snap Linux hypervisor_cpuid_base callee-saved GPR to 0x4000FF00 so each vendor is one CPUID (iron COM2 90c85d5: Booting Linux virt, Loaded initrd, #PF deliver, then n=256 leaf=0x4000bd00). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (Linux hypervisor_cpuid_base GPR bump). Not Everest E5. |
| Months Δ | 0.5→0.5 |
