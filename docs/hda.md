...
| Summary | Stage 46 OPEN hundred-ninety-eighth slice: firmware HLT skip without inject + un-hide PIIX IDE (iron COM2 ea30da1 inject vec=0x20 timer ISR to n=16777216; do not F11 ea30da1 / a2acfc8 / d61dc7e). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (firmware HLT skip without inject). Not Everest E5. |
| Months Δ | 0.5→0.5 |
