...
| Summary | Stage 46 OPEN seventy-first slice: skip 256MiB virtio-blk when leftover would starve OVMF report-RAM (iron pool=194); 64MiB still GPT. TMR2_OUT still in this EFI. Not ISO-INSTALL-OK. M4.3 stays CLOSED. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (PIT 0x61 + disk leave floor). Not Everest E5. |
| Months Δ | 0.5→0.5 |
