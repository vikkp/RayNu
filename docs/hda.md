...
| Summary | Stage 46 OPEN hundred-third slice: HPET 1ms on UART COM I/O so Linux earlycon udelay advances (iron 6e5c84a froze hpet=40191 on in al,dx). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (UART COM HPET 1ms). Not Everest E5. |
| Months Δ | 0.5→0.5 |
