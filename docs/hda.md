...
| Summary | Stage 46 OPEN sixty-ninth slice: MMIO peek RIP when CS.base+RIP misses the 4MiB flash window (leftover real-mode CS.base; iron rip=0xfffcfc86). EAX n>0 fallback + BOOT_SIZE=48 still in this EFI. Not ISO-INSTALL-OK. M4.3 stays CLOSED. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (flash RIP peek). Not Everest E5. |
| Months Δ | 0.5→0.5 |
