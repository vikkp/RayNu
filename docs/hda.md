...
| Summary | Iron COM2 118edcf HLT romwr=0xfffffffe (ROM size probe) still ataio=0; #229 hides product-ISO duplicate slot-0 IDE (keep PIIX). Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. CF8/ROM ladder closed. |
| Gates touched | Stage 46 OPEN (ladder 3a DONE / 3b–3f FAIL / 3g IN PROGRESS). Not Everest E5. |
| Months Δ | 0.5→0.5 |
...
| H9 | PR #231 IdeBus/SCI fork | LOW | **Parked** 2026-09-01 (ADR-015). Tip `8024439` stays parked. COMMAND closed on iron COM2 `c144001` `pcicmd=0x5` still `ataio=0`. CF8/ROM closed on iron COM2 `118edcf` HLT `romwr=0xfffffffe` still `ataio=0`. Do not resume #231 for `COMMAND.IO`. Close path #229 hides product-ISO duplicate slot-0 IDE (keep PIIX). Do not F11 `33630723649` / `33627470674` / `33575888121` / `33573126367` / `33571164257` / `33569757025` / `33567464001` / `33562028442` / `33559849096` / `33558261624` / `33555104832` / `33440050729`. Do not flash `8024439`. |
