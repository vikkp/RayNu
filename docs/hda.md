...
| Summary | Stage 46 OPEN forty-ninth slice: apk repos overwrite (not append) so apk does not hang on mirrors; How would you like → sys (not Which disk like to use). Lab 73728 stub nested stays 65536. Not ISO-INSTALL-OK. M4.3 stays CLOSED. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (apk repos overwrite + `How would you like`→sys, not disk prompt). Not Everest E5. |
| Months Δ | 0.5→0.5 |
