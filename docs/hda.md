...
| Summary | Stage 46 OPEN two-hundred-forty-second slice: nested iso=0 firmware HLT ATA (IDENTIFY WaitForInterrupt IRQ 14 via shadow 8259 0x76; raise_gsi stays product-window) plus firmware SRST ATA IRQ (product SRST deassert raises IRQ 14). CI 33446918467 VMXON-SKIP; F11 pin stays 33440050729. Not ISO-INSTALL-OK. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (nested iso=0 firmware HLT ATA; firmware SRST ATA IRQ; F11 stays 33440050729). Not Everest E5. |
| Months Δ | 0.5→0.5 |
