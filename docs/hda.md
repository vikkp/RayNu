...
| Summary | Stage 46 OPEN sixty-eighth slice: xAPIC EAX fallback when skip-len is 1-15 even if peek got bytes (decode-fail still MOV EAX). BOOT_SIZE=48 + skip-len still in this EFI. Not ISO-INSTALL-OK. M4.3 stays CLOSED. Iron P0-14 stays 2b795a0. |
| Everest impact | months 0.5 held; overall 95 held; ETA 2026-09 held. Not installer. |
| Gates touched | Stage 46 OPEN (xAPIC EAX skip-len). Not Everest E5. |
| Months Δ | 0.5→0.5 |
