...
boot. Not installer. Next: Stage 43 simultaneous virtio `00:00.0` + PIIX
IDE `00:01.1` (`RAYNU-V-M7-E5-OVMF-BOTH-OK`; HLT skip so DXE can walk PCI),
then firmware CD boot (ATAPI/El Torito).
