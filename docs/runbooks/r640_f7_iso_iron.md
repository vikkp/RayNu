...
or `34218742196` (`6cfabee` 3:1 latch lived, same apk `n=1345`) or
...
latch fired; IRQ ratio is not the apk stall. Re-flash from this
virtio-chain-all-segs pin. Do not F11 `34218742196` again expecting `ISO-INSTALL-OK`.
