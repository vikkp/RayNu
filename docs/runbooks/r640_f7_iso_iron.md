...
or `34170268004` (`6692898` FLUSH drain, same apk `n=1345`) or
...
`6692898` / run `34170268004` or `9652262` / run `34149809660`. Yield-PIT
unblocked `usbdelay=30` then starved PIC 11 during apk. FLUSH drain on
`6692898` still froze at the same `n=1345`. Re-flash from this
yield-until-mount pin. Do not F11 `34170268004` or `34149809660` again
...
- **virtio_pci_probe / virtblk_probe IRQ0 storm** (2026-09-07):
  ...
  **still** froze at apk `n=1345`. This pin keeps PIC 11 yield **only
  until** `Mounting boot media: ok.` so apk overlay INTx can complete.
  Do not F11 `34170268004`, `34149809660`, `34148045050`, `34145652767`, `34141401594`, `34135448354`,
