...
or `34172103709` (`c2cd099` stop-yield after mount, same apk `n=1345`) or
...
`c2cd099` / run `34172103709` (or `6692898` / `34170268004` / `9652262`).
Stopping yield after `media: ok` did not move apk. Re-flash from this
3:1-after-usbdelay pin. Do not F11 `34172103709` again expecting `ISO-INSTALL-OK`.
...
- **virtio_pci_probe / virtblk_probe IRQ0 storm** (2026-09-07):
  ...
  **still** froze at apk `n=1345`. `c2cd099` / `34172103709` stopped
  ...
  This pin keeps 1:1 yield during usbdelay, then 3:1 PIC 11:PIT
  (UART or 30s TSC; honor `IRQ11_YIELD_PIT` after mount). Do not F11 `34172103709`, `34170268004`, `34149809660`, `34148045050`, `34145652767`, `34141401594`, `34135448354`,
