...
git log -1 --oneline   # want this SHA (flash 5227ad9 pin 33404368817).
# Pin --run 33404368817 (5227ad9 firmware force IF for inject). do not F11 77f5866.
...
./tools/flashcruzer.sh --no-git --run 33404368817 \
...
# firmware force IF for inject. firmware skip PIT inject. flash 5227ad9.
# firmware arm ATA GSI 14. F11 pin stays --run 33404368817 until this CI.
# --run 33404368817 is F11. --run 33402411199 is not F11. --run 33399209557 is not F11.
# do not F11 77f5866. do not F11 e70a295. do not F11 90da03d.
```
