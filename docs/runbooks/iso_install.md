...
product ISO fw_cfg bootorder virtio-iso scsi@3 first; flash d61dc7e; do not F11 5c0f7a2 (empty scsi@2 second; iso=0 stays CD then disk). Iron COM2 after F11 of that Cruzer is live (bootorder served, ticks printing). Do **not** F11 again while ticks print.
...
git log -1 --oneline   # want d61dc7e; pin run 33349142609 (virtio-iso scsi@3 first).
lsusb | grep -i 0781:5151
./tools/flashcruzer.sh --no-git --wait --require-head --run 33349142609 \
