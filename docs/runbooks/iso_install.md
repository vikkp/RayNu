...
`--run 33391068937` (n>16384 would not have changed that HLT at n~32768). firmware HLT skip without inject. product ISO HLT stall before n=16384. do not F11 ea30da1.
...
git log -1 --oneline   # want this SHA after green CI (firmware HLT skip without inject).
# Do not pin --run 33389381409 (ea30da1 inject vec=0x20 timer ISR). do not F11 ea30da1.
# Do not pin --run 33391068937 (a2acfc8 n>16384 after that boot ended). do not F11 a2acfc8.
