...
git log -1 --oneline   # want this SHA (flash 489d938 pin 33408594472).
# Pin --run 33408594472 (489d938 firmware arm ATA GSI 14). do not F11 5227ad9.
...
./tools/flashcruzer.sh --no-git --run 33408594472 \
...
# firmware arm ATA GSI 14. firmware force IF for inject. firmware skip PIT inject. flash 489d938.
# firmware prefer ATA IRR. F11 pin stays --run 33408594472 until this CI.
# --run 33408594472 is F11. --run 33404368817 is not F11. --run 33402411199 is not F11.
# do not F11 5227ad9. do not F11 77f5866. do not F11 e70a295. do not F11 90da03d.
```
