...
git log -1 --oneline   # want this SHA (flash bce5bbb pin 33411580450).
...
./tools/flashcruzer.sh --no-git --run 33411580450 \
...
# firmware prefer ATA IRR. firmware arm ATA GSI 14. firmware force IF for inject. firmware skip PIT inject. flash bce5bbb.
# firmware prefer ATA IRR. F11 pin is --run 33411580450.
# --run 33411580450 is F11. --run 33408594472 is not F11. --run 33404368817 is not F11.
# do not F11 489d938. do not F11 5227ad9. do not F11 77f5866. do not F11 e70a295.
```
