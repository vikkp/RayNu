...
**ADR-013 Phase 0 census:** [`2026-08-17-phase0-census.md`](2026-08-17-phase0-census.md) — iron pick **`14e4:165f`** BCM5720 dual-port; SNP/LAN is **`01:00.1`**; **`HOST-NIC-HTTP-OK` not claimed**  
