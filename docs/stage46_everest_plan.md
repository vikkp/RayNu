...
| 3b | **FAIL** | Linux `efi:` contains `ACPI=` | IRET to HLT `0x7f0680d0`; `ataio=0` |
...
This #229 HEAD: after the first PIT, **skip HLT** (no more PIT). Do not F11 `e3cbfa5` / `33558261624`. Do not F11 `24c5fa6` / `33555104832`. Do not F11 `b5c3a9c`.
