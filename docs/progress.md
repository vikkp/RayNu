...
| Gate | Marker | Goal |
|------|--------|------|
| E3b Durable HTTP | `RAYNU-V-M7-HOST-NIC-HTTP-OK` | Phase 0 closed (`14e4:165f`). Station `:3a` on iron; `link=timeout bmsr=7949` (AN incomplete). `tg3` BMCR_RESET + AUXCTL PWRCTL + Auto-MDIX. SNP/Tcp4 do not count. |
