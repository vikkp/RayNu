...
| E5 Stage 44 | `RAYNU-V-M7-E5-OVMF-ATAPI-OK` | **OPEN** host: iron COM2 LIVE-BYTES-OK then #UD RIP `0x109D` `pci_ide=0` `com=15515` (guest-UEFI lacked INVPCID/XSAVES/RDTSCP). Nested VT-x `2674629` BOTH-OK then ACPI BdsWait. Not El Torito boot. Not installer (2026-08-23). |
...
| P0-59 / E5 Stage 44 | `RAYNU-V-M7-E5-OVMF-ATAPI-OK` | **OPEN (host).** Iron COM2 #UD RIP `0x109D` `pci_ide=0`. Guest-UEFI INVPCID/RDTSCP/XSAVES. Stop on `sectors>0`. Not El Torito boot. Not installer. Not Everest E5. |
