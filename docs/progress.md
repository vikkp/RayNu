...
| Gate | Marker | Goal |
|------|--------|------|
| E3b Durable HTTP | `RAYNU-V-M7-HOST-NIC-HTTP-OK` | Phase 0 closed (`14e4:165f`). CORECLK-sans-BMCR EFI `1404f055` still `cand bmsr=7949` / `link=timeout`. PCI restore + `phy_setup=post`. SNP/Tcp4 do not count. |
