...
| Gate | Marker | Goal |
|------|--------|------|
| E3b Durable HTTP | `RAYNU-V-M7-HOST-NIC-HTTP-OK` | Dedicated iDRAC + host LOM `:38` `link=up` (2026-08-19). Keep APE PHY. Native DMA/`CORECLK_RESET` next. SNP/Tcp4 do not count. |
