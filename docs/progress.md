...
| `mgmt/ha` / `m6_ha_gate` | L0 | Mock HA failover + harden checklist (M6.6 wired) |
...
**M6.6 wired** (Latitude pending). Plan: [m6_plan.md](m6_plan.md) · prior: [m5_plan.md](m5_plan.md) · [m4_plan.md](m4_plan.md)
...
| **M6.6** ← wired | `RAYNU-V-M6-HA-OK` | HA / security harden (Latitude pending) |
