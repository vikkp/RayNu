...
| E5 Stage 44 | `RAYNU-V-M7-E5-OVMF-ATAPI-OK` | **OPEN** host: iron `b4b4847` EFER.LMA `efer=0xd00` `pg=1` `csl=1` still ASSERT `callerrip=0x1d25193`. `r8` is `gPcdDataBaseSignatureGuid`. Not installer (2026-08-23). |
...
**P0-59 / E5 Stage 44 open (host):** firmware ATAPI READ (`RAYNU-V-M7-E5-OVMF-ATAPI-OK`). Iron COM2 `b4b4847`: EFER.LMA applied (`efer=0xd00` LME+LMA+NXE, `pg=1` `csl=1`) still ASSERT `callerrip=0x1d25193`. `r8` is `gPcdDataBaseSignatureGuid`. Do not skip iron `eb ec`. Not El Torito boot. Not installer. Not Everest E5.  
...
| P0-59 / E5 Stage 44 | `RAYNU-V-M7-E5-OVMF-ATAPI-OK` | **OPEN (host).** Iron `b4b4847` EFER.LMA `efer=0xd00` still ASSERT `callerrip=0x1d25193`. `r8` is `gPcdDataBaseSignatureGuid`. Stop on `sectors>0`. Not El Torito boot. Not installer. Not Everest E5. |
