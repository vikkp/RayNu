...
| E5 Stage 44 | `RAYNU-V-M7-E5-OVMF-ATAPI-OK` | **OPEN** host: PIIX3 ISA PIRQ after nested VT-x `8e55abf` `cf8=0x80000838` ISA `00:01.0:0x38`. Not El Torito boot. Not installer (2026-08-23). |
...
| P0-59 / E5 Stage 44 | `RAYNU-V-M7-E5-OVMF-ATAPI-OK` | **OPEN (host).** Nested VT-x `8e55abf` n=2048 `cf8=0x80000838` ISA `00:01.0:0x38`. PIIX PIRQ `0x80`. 8192-exit cap. Stop on `sectors>0`. Not El Torito boot. Not installer. Not Everest E5. |
