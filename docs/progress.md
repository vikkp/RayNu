...
| M7.5 | `RAYNU-V-M7-R640-SCAFFOLD-OK` | R640 runbook + evidence scaffold (CI); iron **M0 first light** 2026-08-15; `RAYNU-V-R640-BOOT-OK` **open** (SOL residual) |
...
| `mgmt/m7_r640_gate` | L0 | R640 scaffold + iron M0 first-light evidence (2026-08-15); BOOT-OK open |
...
**M7.5 partial on iron:** real R640 showed `RAYNU-V-M0-BOOT-OK` (iDRAC Virtual Floppy, 2026-08-15 evidence).  
**`RAYNU-V-R640-BOOT-OK` still open** — post-M0 COM1/SOL not captured.  
...
| Gate | Marker | Goal |
|------|--------|------|
| M7.5 | `RAYNU-V-R640-BOOT-OK` | Real PowerEdge R640 boot past M0 on COM1/SOL (**next hard gate**) |
