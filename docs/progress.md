...
| `audit/report` | L0 | SOX/ISO JSON/CSV/PDF from ring snapshot; REPORT-OK (M5.4); PDF closed M6.5 (wired) |
...
**M6.5 wired** (Latitude pending). Plan: [m6_plan.md](m6_plan.md) · prior: [m5_plan.md](m5_plan.md) · [m4_plan.md](m4_plan.md)
...
| **M6.5** ← wired | `RAYNU-V-M6-PDF-OK` | PDF audit reports (Latitude pending) |
