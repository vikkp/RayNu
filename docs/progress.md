...
| Gate | Marker | Goal |
|------|--------|------|
| E3b Durable HTTP | `RAYNU-V-M7-HOST-NIC-HTTP-OK` | Phase 0 closed (`14e4:165f`). Phase D **driver in-tree** (poll-mode BCM5720). Iron exchange **open**. SNP/Tcp4 do not count. |
