...
**M6.8 closed** on Latitude. Next: [m6_plan.md](m6_plan.md) · prior: [m5_plan.md](m5_plan.md) · [m4_plan.md](m4_plan.md)
...
| **M6.9** ← next | `RAYNU-V-M6-EXT-OK` | External audit + spec review |
