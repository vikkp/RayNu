...
| E5 Stage 44 | `RAYNU-V-M7-E5-OVMF-ATAPI-OK` | **OPEN** host: 8192-exit cap after nested VT-x `8e55abf` `ata=0` `unh=0` still PciBus. Not El Torito boot. Not installer (2026-08-23). |
...
**P0-59 / E5 Stage 44 open (host):** firmware ATAPI READ (`RAYNU-V-M7-E5-OVMF-ATAPI-OK`). Stop predicate is honest `sectors>0`. Nested VT-x `8e55abf` BOTH-OK then n=2048 `ata=0x0` `unh=0` `port=0xcf8` (still PciBus). 8192-exit cap so firmware can leave config and issue PACKET. Not El Torito boot. Not installer. Not Everest E5.  
...
| P0-59 / E5 Stage 44 | `RAYNU-V-M7-E5-OVMF-ATAPI-OK` | **OPEN (host).** Nested VT-x `8e55abf` n=2048 `ata=0` `unh=0` still PciBus. 8192-exit cap. Stop on `sectors>0`. Not El Torito boot. Not installer. Not Everest E5. |
