...
| P0-62 / E5 Stage 46 | `ISO-INSTALL-OK` | **OPEN.** Linux ISO install to virtio-blk. Everest E5. Waits on Stage 45 + P0-60 + G0 relocate + M4.3 ladder (all closed). `ISO-BOOTED-FROM-DISK` is persist-detect, not this gate. |
