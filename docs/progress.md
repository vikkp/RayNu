...
**E4 SPA VMLAUNCH:** Cruzer `RAYNUV` flashed relocate+fail-soft EFI `618e89e2`. Iron printed `RAYNU-V-M7-E4-SPA-LAUNCH-OK` then `VMPTRLD slot=0` in a loop (fail-soft held VMX; memcpy of G0 VMCS is not VMPTRLD-safe). **Not E4 closed.** Next EFI clones G0 via VMREAD/VMWRITE and sticky-parks slot 0. Guest is SHELL CPUID, not a distro installer.  
Plan: [m7_plan.md](m7_plan.md) · HDA: [hda.md](hda.md) · evidence: [evidence/r640/2026-08-21-e4-g0reloc-spa-vmptrld-loop.md](evidence/r640/2026-08-21-e4-g0reloc-spa-vmptrld-loop.md)
...
| E4 SPA VMLAUNCH | `RAYNU-V-M7-E4-SPA-LAUNCH-OK` | **IN PROGRESS** — `618e89e2` printed marker then memcpy VMPTRLD loop (fail-soft, no VMXOFF). Not closed. |
