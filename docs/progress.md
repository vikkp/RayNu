...
| E5 Stage 44 | `RAYNU-V-M7-E5-OVMF-ATAPI-OK` | **OPEN** host: iron `891eb5b` OSXSAVE CR4 intercept then skip of `ebecc9c3` (`leave; ret`) escaped ASSERT → `#UD` PE-header `0x109D` stop n=1439. Do not skip that jmp; dump ASSERT retaddr. Nested VT-x `2674629` BOTH-OK then ACPI BdsWait. Not El Torito boot. Not installer (2026-08-23). |
...
**P0-59 / E5 Stage 44 open (host):** firmware ATAPI READ (`RAYNU-V-M7-E5-OVMF-ATAPI-OK`). Iron COM2 `891eb5b`: OSXSAVE CR4 intercept + `#UD` stop n=1439 after skip of `ebecc9c3` (`leave; ret`) escaped ASSERT into PE-header `#UD` at `0x109D`. Do not skip that jmp; dump ASSERT return address. fw_cfg CD path is PIIX `ide@1,1` then virtio-fn1 `ide@0,1` master `drive@0`. Nested VT-x `2674629` BOTH-OK then ACPI BdsWait. Not El Torito boot. Not installer. Not Everest E5.  
...
| P0-59 / E5 Stage 44 | `RAYNU-V-M7-E5-OVMF-ATAPI-OK` | **OPEN (host).** Iron `891eb5b` skipped `ebecc9c3` then `#UD` `0x109D`. Do not skip ASSERT `leave; ret`. Stop on `sectors>0`. Not El Torito boot. Not installer. Not Everest E5. |
