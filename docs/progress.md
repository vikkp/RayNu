...
| E5 Stage 44 | `RAYNU-V-M7-E5-OVMF-ATAPI-OK` | **OPEN** host: iron `ad78f12` ASSERT noskip `ret=0x6e8946` after seven `RDMSR 0x1B` (APIC_BASE) then CPUID `0x1cf11b5`. xAPIC MMIO was a 2MiB zero sink (`GetApicVersion()==0`). Map 4KiB xAPIC version `0x50014`. Not El Torito boot. Not installer (2026-08-23). |
...
**P0-59 / E5 Stage 44 open (host):** firmware ATAPI READ (`RAYNU-V-M7-E5-OVMF-ATAPI-OK`). Iron COM2 `ad78f12`: ASSERT noskip `ret=0x6e8946` after seven `RDMSR 0x1B` then CPUID `0x1cf11b5`. xAPIC MMIO was a 2MiB zero sink; map 4KiB xAPIC version `0x50014`. Not El Torito boot. Not installer. Not Everest E5.  
...
| P0-59 / E5 Stage 44 | `RAYNU-V-M7-E5-OVMF-ATAPI-OK` | **OPEN (host).** Iron `ad78f12` ASSERT `ret=0x6e8946` after RDMSR APIC_BASE; xAPIC 4K not sink zeros. Stop on `sectors>0`. Not El Torito boot. Not installer. Not Everest E5. |
