...
| Gate | Marker | Goal |
|------|--------|------|
| E3b Durable HTTP | `RAYNU-V-M7-HOST-NIC-HTTP-OK` | Phase 0 census print + Phase E arena on host; Phase C **QEMU GET /** closed. Iron Phase D open (flash census EFI, pick one `vid:did`). SNP/Tcp4 do not count. |
