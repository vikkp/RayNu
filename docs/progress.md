...
| Gate | Marker | Goal |
|------|--------|------|
| E3b Durable HTTP | `RAYNU-V-M7-HOST-NIC-HTTP-OK` | Phase 0 closed (`14e4:165f`). Station `:3a`. PHY-reset EFI still `bmsr=7949`/`lpa=0000`. Peek BMSR before `CORECLK_RESET`; inherit SNP PHY or `tg3_phy_toggle_apd(false)`. SNP/Tcp4 do not count. |
