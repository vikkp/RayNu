...
| P0-58 / E5 Stage 43 | `RAYNU-V-M7-E5-OVMF-BOTH-OK` | **OPEN (host).** Firmware-simultaneous virtio `00:00.0` + IDE `00:00.1`. Nested VT-x `1991a27`: remap n=1, `acpi=13`, `dxe=1`, then EPT `gpa=0xffc00000` (VARS gap). 4 MiB flash window next. Still `sectors=0`. Not installer. Not Everest E5. |
