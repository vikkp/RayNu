...
| E5 Stage 44 | `RAYNU-V-M7-E5-OVMF-ATAPI-OK` | **OPEN** host: iron `10cb881` VCNT=8 power-on still ASSERT `mtrr0=0x80000000`. VCNT=32 power-on, no hole. Not installer (2026-08-23). |
...
**P0-59 / E5 Stage 44 open (host):** firmware ATAPI READ (`RAYNU-V-M7-E5-OVMF-ATAPI-OK`). Iron COM2 `10cb881`: VCNT=8 power-on still ASSERT `callerrip=0x1d25193` `mtrrdef=0xc06` `mtrr0=0x80000000`. No skip. VCNT=32 power-on, no UC hole. Not El Torito boot. Not installer. Not Everest E5.  
...
| P0-59 / E5 Stage 44 | `RAYNU-V-M7-E5-OVMF-ATAPI-OK` | **OPEN (host).** Iron `10cb881` VCNT=8 power-on still ASSERT `mtrr0=0x80000000`. VCNT=32 power-on, no hole. Stop on `sectors>0`. Not El Torito boot. Not installer. Not Everest E5. |
