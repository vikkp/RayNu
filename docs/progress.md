...
| Gate | Marker | Goal |
|------|--------|------|
| E3b Durable HTTP | `RAYNU-V-M7-HOST-NIC-HTTP-OK` | Phase 0 closed (`14e4:165f`). APE-lock EFI: `ape-lock=yes` still `bmsr=7949`. Linux `tg3_reset_hw` PHY reset before CORECLK_RESET. SNP/Tcp4 do not count. |
