...
| Gate | Marker | Goal |
|------|--------|------|
| E3b Durable HTTP | `RAYNU-V-M7-HOST-NIC-HTTP-OK` | Phase 0 closed (`14e4:165f`). PHY-before-reset EFI `1213952`: `phy_reset=pre` then `CORECLK_RESET` still `bmsr=7949` / `lpa=0000`. Skip chip reset. SNP/Tcp4 do not count. |
