...
| Gate | Marker | Goal |
|------|--------|------|
| E3b Durable HTTP | `RAYNU-V-M7-HOST-NIC-HTTP-OK` | Phase 0 closed (`14e4:165f`). Skip-BMCR EFI still `cand bmsr=7949` at EBS. CORECLK_RESET without BMCR. SNP/Tcp4 do not count. |
