...
| E5 Stage 45 | `RAYNU-V-M7-E5-OVMF-ELTORITO-OK` | **OPEN** (named). Firmware El Torito CD boot. Work order: 45 → P0-60 → 46. Not installer (2026-08-27). |
...
**After Stage 44 (named, not started):** Stage 45 El Torito (`OVMF-ELTORITO-OK`) → P0-60 G1 EPT (not an E5 stage) → Stage 46 `ISO-INSTALL-OK`.  
...
| P0-61 / E5 Stage 45 | `RAYNU-V-M7-E5-OVMF-ELTORITO-OK` | **OPEN.** Firmware El Torito CD boot. Not installer. Not Everest E5. Work order: 45 → P0-60 → 46. |
