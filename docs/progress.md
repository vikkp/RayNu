...
| Gate | Marker | Goal |
|------|--------|------|
| E3b Durable HTTP | `RAYNU-V-M7-HOST-NIC-HTTP-OK` | Phase 0 closed (`14e4:165f`). Inherit EFI: `pre-reset bmsr=7949 ape=yes` (no inherit). APE BAR2 `tg3_ape_lock` + driver START. SNP/Tcp4 do not count. |
