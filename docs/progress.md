...
| P0-62 / E5 Stage 46 | `ISO-INSTALL-OK` | **OPEN.** First slice: product ISO window + continue past lab El Torito stop. Not closed. `ISO-BOOTED-FROM-DISK` is persist-detect, not this gate. Host/CI never prints the iron OK. |
