...
## Verification checkpoint (as of M7.2 closed)
...
| `mgmt/iso` / `m7_iso_gate` | L0 | ISO extract-boot + virtio install plan; ISO-OK wired (M7.3); CD-ROM stub |
...
**M7.2 closed** on Latitude. **M7.3 wired** (`RAYNU-V-M7-ISO-OK`; Latitude pending).  
Plan: [m7_plan.md](m7_plan.md) · HDA: [hda.md](hda.md) · prior: [m6_plan.md](m6_plan.md)

| Gate | Marker | Goal |
|------|--------|------|
| M7.3 | `RAYNU-V-M7-ISO-OK` | ISO extract-boot + virtio install disk (**wired**; Latitude pending) |
