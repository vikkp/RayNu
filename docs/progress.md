...
**E4 SPA VMLAUNCH:** in-tree on coexist (private 2 MiB EPT + slab VMCS). Host wiring only until COM2 `RAYNU-V-M7-E4-SPA-LAUNCH-OK`. Not a Linux guest / distro installer.  
Plan: [m7_plan.md](m7_plan.md) · HDA: [hda.md](hda.md) · evidence: [evidence/r640/2026-08-20-phase-f-coexist-ok.md](evidence/r640/2026-08-20-phase-f-coexist-ok.md)
...
| E4 SPA VMLAUNCH | `RAYNU-V-M7-E4-SPA-LAUNCH-OK` | **IN TREE (host)** — SPA start queues private-EPT SHELL in the G1 slab. Iron COM2 not claimed. |
