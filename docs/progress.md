...
| E5 Stage 44 | `RAYNU-V-M7-E5-OVMF-ATAPI-OK` | **OPEN** host: iron `17449e2` ASSERT noskip `ret=0x6e8946` `rip=0x6e81ca` after host CPUID. Filter guest-UEFI CPUID uniprocessor + hide VMX; FEATURE_CONTROL lock. Not El Torito boot. Not installer (2026-08-23). |
...
**P0-59 / E5 Stage 44 open (host):** firmware ATAPI READ (`RAYNU-V-M7-E5-OVMF-ATAPI-OK`). Iron COM2 `17449e2`: ASSERT noskip `ret=0x6e8946` `rip=0x6e81ca` after host CPUID (Xeon topology+VMX). Guest-UEFI CPUID is uniprocessor, VMX/x2APIC hidden, FEATURE_CONTROL locked. Not El Torito boot. Not installer. Not Everest E5.  
...
| P0-59 / E5 Stage 44 | `RAYNU-V-M7-E5-OVMF-ATAPI-OK` | **OPEN (host).** Iron `17449e2` ASSERT `ret=0x6e8946`. CPUID uniprocessor + FEATURE_CONTROL lock. Stop on `sectors>0`. Not El Torito boot. Not installer. Not Everest E5. |
