...
| E5 Stage 44 | `RAYNU-V-M7-E5-OVMF-ATAPI-OK` | **OPEN** host: iron `408788c` MTRR walk completed, still ASSERT `ret=0x6e8946` after CPUID `0x1cf11b5`. Guest-UEFI hypervisor CPUID + `KVMKVMKVM` (nested KVM vs iron). Not El Torito boot. Not installer (2026-08-23). |
...
**P0-59 / E5 Stage 44 open (host):** firmware ATAPI READ (`RAYNU-V-M7-E5-OVMF-ATAPI-OK`). Iron COM2 `408788c`: MTRR walk completed; still ASSERT after CPUID `0x1cf11b5`. Guest-UEFI hypervisor CPUID + `KVMKVMKVM`. Not El Torito boot. Not installer. Not Everest E5.  
...
| P0-59 / E5 Stage 44 | `RAYNU-V-M7-E5-OVMF-ATAPI-OK` | **OPEN (host).** Iron `408788c` MTRR walk done, still ASSERT after CPUID `0x1cf11b5`; hypervisor CPUID + KVM signature. Stop on `sectors>0`. Not El Torito boot. Not installer. Not Everest E5. |
