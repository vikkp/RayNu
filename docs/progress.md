...
| E5 Stage 44 | `RAYNU-V-M7-E5-OVMF-ATAPI-OK` | **OPEN** host: iron `3f417ca` xAPIC 4K mapped, still ASSERT `ret=0x6e8946` after MTRR walk `0xFE`/`0x2FF`/`0x250`. Shadow guest MTRRs (not host). Not El Torito boot. Not installer (2026-08-23). |
...
**P0-59 / E5 Stage 44 open (host):** firmware ATAPI READ (`RAYNU-V-M7-E5-OVMF-ATAPI-OK`). Iron COM2 `3f417ca`: xAPIC 4K `ver=0x50014` mapped; still ASSERT after MTRR `0xFE`/`0x2FF`/`0x250`. Shadow guest MTRRs. Not El Torito boot. Not installer. Not Everest E5.  
...
| P0-59 / E5 Stage 44 | `RAYNU-V-M7-E5-OVMF-ATAPI-OK` | **OPEN (host).** Iron `3f417ca` ASSERT after MTRR walk; guest MTRR shadow. Stop on `sectors>0`. Not El Torito boot. Not installer. Not Everest E5. |
