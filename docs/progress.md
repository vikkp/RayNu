...
| E5 Stage 44 | `RAYNU-V-M7-E5-OVMF-ATAPI-OK` | **OPEN** host: ATAPI signature + PACKET interrupt-reason; stop on `sectors>0` (not both-enum-alone). Nested VT-x pending. Not El Torito boot. Not installer (2026-08-23). |
...
**P0-59 / E5 Stage 44 open (host):** firmware ATAPI READ (`RAYNU-V-M7-E5-OVMF-ATAPI-OK`). Stop predicate is honest `sectors>0` (Stage 43 both-enum-alone stopped at n=1111 with `sectors=0`). ATAPI signature + PACKET interrupt-reason. Nested VT-x pending. Not El Torito boot. Not installer. Not Everest E5.  
...
| P0-59 / E5 Stage 44 | `RAYNU-V-M7-E5-OVMF-ATAPI-OK` | **OPEN (host).** ATAPI signature + PACKET so firmware can `READ(10)`. Stop on `sectors>0`, not both-enum-alone. Nested VT-x pending. Not El Torito boot. Not installer. Not Everest E5. |
