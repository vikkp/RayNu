...
| Gate | Marker | Goal |
|------|--------|------|
| E3b Durable HTTP | `RAYNU-V-M7-HOST-NIC-HTTP-OK` | Phase 0 closed (`14e4:165f`). Station `:3a` programmed on iron; ping host-unreachable (no ARP). PHY `BMSR_LSTATUS` + MII/GMII + PROMISC next. SNP/Tcp4 do not count. |
