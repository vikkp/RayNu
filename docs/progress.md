...
| E5 Stage 44 | `RAYNU-V-M7-E5-OVMF-ATAPI-OK` | **OPEN** host: iron `8700cbb` hypervisor CPUID still ASSERT `callerrip=0x1d25193` after WRMSR/RDMSR. MTRR VCNT=32 + PCI UC hole + bootorder NUL. Not El Torito boot. Not installer (2026-08-23). |
...
**P0-59 / E5 Stage 44 open (host):** firmware ATAPI READ (`RAYNU-V-M7-E5-OVMF-ATAPI-OK`). Iron COM2 `8700cbb`: hypervisor CPUID still ASSERT `callerrip=0x1d25193` after WRMSR then RDMSR spin. MTRR VCNT=32 + PCI UC 1GiB + fw_cfg bootorder NUL. Not El Torito boot. Not installer. Not Everest E5.  
...
| P0-59 / E5 Stage 44 | `RAYNU-V-M7-E5-OVMF-ATAPI-OK` | **OPEN (host).** Iron `8700cbb` hypervisor CPUID still ASSERT `callerrip=0x1d25193`; MTRR VCNT=32 + PCI UC hole + bootorder NUL. Stop on `sectors>0`. Not El Torito boot. Not installer. Not Everest E5. |
