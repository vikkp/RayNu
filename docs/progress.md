...
**M6.6 closed** on Latitude. Next: [m6_plan.md](m6_plan.md) · prior: [m5_plan.md](m5_plan.md) · [m4_plan.md](m4_plan.md)
...
| **M6.7** ← next | `RAYNU-V-M6-FAULT-OK` | Fault injection suite |
