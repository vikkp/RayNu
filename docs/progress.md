...
| Gate | Marker | Goal |
|------|--------|------|
| E3b Durable HTTP | `RAYNU-V-M7-HOST-NIC-HTTP-OK` | Phase 0 closed (`14e4:165f`). PRE-EBS peek: SNP `:3a` copper, host GPHY `bmsr=7949`. Keep APE PHY (iDRAC NCSI). SNP/Tcp4 do not count. |
