...
| E5 Stage 44 | `RAYNU-V-M7-E5-OVMF-ATAPI-OK` | **OPEN** host: iron `0b7d647` VCNT=32 (`0xfe=0x520`) still ASSERT `callerrip=0x1d25193` `lastmsr=EFER`. QEMU BOTH-OK skipped `eb f3`. EFER.LMA = LME && CR0.PG; IA-32e entry; debugcon 0x402. Not installer (2026-08-23). |
...
**P0-59 / E5 Stage 44 open (host):** firmware ATAPI READ (`RAYNU-V-M7-E5-OVMF-ATAPI-OK`). Iron COM2 `0b7d647`: VCNT=32 (`0xfe=0x520`) PCI UC hole present, firmware then zeroed `0x200`, same ASSERT `callerrip=0x1d25193` `lastmsr=EFER`. QEMU BOTH-OK skipped `eb f3`. EFER.LMA = LME && CR0.PG; IA-32e entry matches LMA; debugcon 0x402. Not El Torito boot. Not installer. Not Everest E5.  
...
| P0-59 / E5 Stage 44 | `RAYNU-V-M7-E5-OVMF-ATAPI-OK` | **OPEN (host).** Iron `0b7d647` VCNT=32 still ASSERT `callerrip=0x1d25193` `lastmsr=EFER`. EFER.LMA = LME && CR0.PG; IA-32e entry; debugcon 0x402. Stop on `sectors>0`. Not El Torito boot. Not installer. Not Everest E5. |
