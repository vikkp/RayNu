...
| Gate | Marker | Goal |
|------|--------|------|
| E3b Durable HTTP | `RAYNU-V-M7-HOST-NIC-HTTP-OK` | Phase 0 closed (`14e4:165f`). Skip-reset EFI `1212416`: `ape-ncsi=yes` still `bmsr=7949` on func 1. Try both funcs. SNP/Tcp4 do not count. |
