...
| Gate | Marker | Notes |
|------|--------|-------|
| M3.21 | `RAYNU-V-M3-KANI-OK` | Hard-fail Kani CI (pin 0.67.0); awaiting CI + Latitude smoke |
...
| `vmx/*` | L0–L1 | Real Linux through EPT3 + APIC + SHELL + NOIRQ (M3.20) |
...
| Gate | Marker | Goal |
|------|--------|------|
| **M3.21** ← next | `RAYNU-V-M3-KANI-OK` | Harden Kani CI hard-fail (this PR) |
