...
| E5 Stage 44 | `RAYNU-V-M7-E5-OVMF-ATAPI-OK` | **OPEN** host: ATAPI signature + PACKET; 8-byte IDE BAR + diagnostic `0x90`. Nested VT-x `80129d3` stop `packet=0` `sectors=0`. Not El Torito boot. Not installer (2026-08-23). |
...
**P0-59 / E5 Stage 44 open (host):** firmware ATAPI READ (`RAYNU-V-M7-E5-OVMF-ATAPI-OK`). Stop predicate is honest `sectors>0` (Stage 43 both-enum-alone stopped at n=1111 with `sectors=0`). Nested VT-x `80129d3` ran to n=2048 after BOTH-OK with `packet=0` `sectors=0`. 8-byte command BAR + BAR-relocated ATA, diagnostic `0x90`, BMIDE BAR4 RAZ/WI. Not El Torito boot. Not installer. Not Everest E5.  
...
| P0-59 / E5 Stage 44 | `RAYNU-V-M7-E5-OVMF-ATAPI-OK` | **OPEN (host).** Nested VT-x `80129d3` n=2048 `packet=0` `sectors=0`. 8-byte IDE BAR + diagnostic `0x90` + BMIDE BAR4. Stop on `sectors>0`, not both-enum-alone. Not El Torito boot. Not installer. Not Everest E5. |
