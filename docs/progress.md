...
| E5 Stage 44 | `RAYNU-V-M7-E5-OVMF-ATAPI-OK` | **OPEN** host: iron `c40f4a8` `pcdsig=1` `efer=0xd00` still ASSERT `callerrip=0x1d25193`. Guarded DXE `eb ec` skip when RIP/caller in `[1MiB,32MiB)`. Not installer (2026-08-23). |
...
**P0-59 / E5 Stage 44 open (host):** firmware ATAPI READ (`RAYNU-V-M7-E5-OVMF-ATAPI-OK`). Iron COM2 `c40f4a8`: `pcdsig=1` after 32-pair MTRR walk, `efer=0xd00` `pg=1` `csl=1` still ASSERT `callerrip=0x1d25193`. Guarded DXE `eb ec` skip when RIP and caller are in `[1MiB,32MiB)` (not PE-header `0x109D`). Not El Torito boot. Not installer. Not Everest E5.  
...
| P0-59 / E5 Stage 44 | `RAYNU-V-M7-E5-OVMF-ATAPI-OK` | **OPEN (host).** Iron `c40f4a8` `pcdsig=1` still ASSERT `callerrip=0x1d25193`. Guarded DXE `eb ec` skip when RIP/caller in `[1MiB,32MiB)`. Stop on `sectors>0`. Not El Torito boot. Not installer. Not Everest E5. |
