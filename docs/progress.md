...
| E5 Stage 45 | `RAYNU-V-M7-E5-OVMF-ELTORITO-OK` | **OPEN** (in progress). Host package: keep VMCS after first ATAPI sector; checksummed catalog; FAT12 ESP `\EFI\BOOT\BOOTX64.EFI`; catalog+load READ + `RN-ELT`; do not apply the 32768 post-ATAPI tail after PACKET (first sector is often LBA 0 dummy); 131072-exit cap. Nested VT-x or iron COM2 to close. Not installer (2026-08-27). |
