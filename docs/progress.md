...
| Gate | Marker | Goal |
|------|--------|------|
| E3b Durable HTTP | `RAYNU-V-M7-HOST-NIC-HTTP-OK` | Phase 0 **closed on iron** (`14e4:165f` BCM5720). Phase C QEMU GET / closed. Phase D driver open. SNP/Tcp4 do not count. |
