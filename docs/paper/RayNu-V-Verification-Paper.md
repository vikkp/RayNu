...
- **Mount Everest residual (not paper L3 claims):** TLS/console, real distro installer, live Redfish, R640 soak. E2+E3+E3b+E5+P0-14 closed on iron through 2026-08-21 (`RAYNU-V-M7-E4-SPA-LAUNCH-OK` — SHELL stub, not a distro). Firmware SNP hung then RSOD after EBS; WARN-only idle later closed with no RSOD; Tcp4 is a platform limit. LBA stamps ≠ guest rootfs. PRE-EBS SNP remains the bring-up mgmt UI.
