...
- **Mount Everest residual (not paper L3 claims):** E4 polish (TLS/console), distro ISO / El Torito, live Redfish, R640 soak. E5 stamp persist closed on iron (`BOOTED-FROM-DISK`).
