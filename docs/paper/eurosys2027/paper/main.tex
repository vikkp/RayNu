...
content-addressed Linux zip, SHA-256 pinned; CI never uses \texttt{latest})
and Kani 0.67.0.
The exclusivity crate is verified with \texttt{cargo verus verify}. The last closed host gate on that crate reported \textbf{80
...
\begin{table*}[t]
  ...
  \begin{tabularx}{\textwidth}{@{}L ccc@{}}
    ...
    Multi-VM probes & L3 $N$-guest & --- & probes on iron \\
