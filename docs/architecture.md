...
**M3.19 closed:** no IRQ4 inject; IRQ0 until SHELL; no `console=ttyS0` → `RAYNU-V-M3-NOIRQ-OK`. Next: M3.20 EPT3 (optional) or M3.21/M3.22 — [m3_post_shell_plan.md](m3_post_shell_plan.md).
