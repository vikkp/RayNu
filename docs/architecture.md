...
**Through M7.4 closed** (`RAYNU-V-M7-UI-OK` host smoke; console/TLS/NIC residual). **M7.5 iron closed** (`RAYNU-V-R640-BOOT-OK`, 2026-08-15) — [m7_plan.md](m7_plan.md) · [ADR-009](adr/ADR-009.md) · [hda.md](hda.md) · [progress.md](progress.md).
