...
**Through M7.2 wired** (`RAYNU-V-M7-STORE-OK`; Latitude pending). Next after close: **M7.3 ISO** — [m7_plan.md](m7_plan.md) · [ADR-009](adr/ADR-009.md) · [hda.md](hda.md) · [progress.md](progress.md).
