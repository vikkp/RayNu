...
**Through M7.4 closed** (`RAYNU-V-M7-UI-OK` host smoke; console/TLS/NIC residual). Next: **M7.5 R640** — [m7_plan.md](m7_plan.md) · [ADR-009](adr/ADR-009.md) · [hda.md](hda.md) · [progress.md](progress.md).
