...
**Next M6.2:** NUMA affinity L3 → `RAYNU-V-M6-NUMA-L3-OK` — [m6_plan.md](m6_plan.md) / [progress.md](progress.md). M6.1 closed on Latitude (`RAYNU-V-M6-HWPTE-OK`; `72 verified, 0 errors`).
