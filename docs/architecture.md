...
Boot path today (**M3.7 closed**): UEFI entry → ESP/embedded bzImage load → VMLAUNCH → … → exit loop → VMXOFF. Verification: L2 specs + Kani.
...
**M3.7 closed** on Latitude (`RAYNU-V-M3-BZIMAGE-OK`). Next: **M3.8** real Linux earlyprintk. Plan: [m3_plan.md](m3_plan.md).
