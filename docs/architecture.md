...
**Through M7.3 wired** (`RAYNU-V-M7-ISO-OK`; Latitude pending). Next after close: **M7.4 UI** — [m7_plan.md](m7_plan.md) · [ADR-009](adr/ADR-009.md) · [hda.md](hda.md) · [progress.md](progress.md).
