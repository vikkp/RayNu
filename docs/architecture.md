...
**Through M7.1 wired** (`RAYNU-V-M7-HTTP-OK`; Latitude pending). Next after close: **M7.2 datastore** — [m7_plan.md](m7_plan.md) · [ADR-009](adr/ADR-009.md) · [hda.md](hda.md) · [progress.md](progress.md).
