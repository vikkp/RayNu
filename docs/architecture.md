...
**Next M6.4:** REST auth → `RAYNU-V-M6-AUTH-OK` — [m6_plan.md](m6_plan.md) / [progress.md](progress.md). M6.3 wired (`RAYNU-V-M6-MIGRATE-XFER-OK`; `80 verified, 0 errors` locally; Latitude pending).
