...
**Next M6.6:** HA / security harden → `RAYNU-V-M6-HA-OK` — [m6_plan.md](m6_plan.md) / [progress.md](progress.md). M6.5 wired (`RAYNU-V-M6-PDF-OK`; Latitude pending). M6.4 closed on Latitude (`RAYNU-V-M6-AUTH-OK`).
