...
**Through M7.4 wired** (`RAYNU-V-M7-UI-OK`; Latitude pending). Next after close: **M7.5 R640** — [m7_plan.md](m7_plan.md) · [ADR-009](adr/ADR-009.md) · [hda.md](hda.md) · [progress.md](progress.md).
