...
/// Stage 28 may flip this when a private guest-UEFI path can read real
...
/// Guest UEFI VMLAUNCH from ESP `\\EFI\\RayNu\\OVMF.fd` (ADR-014 Stage 27).
///
/// INVARIANTS:
...
/// - Live ESP read-attempted, still absent →
