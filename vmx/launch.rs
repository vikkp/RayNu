...
/// Stage 25 may flip this when a private guest-UEFI path can read real
/// ESP bytes (not this fixture, not the E4 SHELL path).
...
/// Guest UEFI VMLAUNCH from ESP `\\EFI\\RayNu\\OVMF.fd` (ADR-014 Stage 24).
///
/// INVARIANTS:
