...
/// Stage 26 may flip this when a private guest-UEFI path can read real
...
/// Guest UEFI VMLAUNCH from ESP `\\EFI\\RayNu\\OVMF.fd` (ADR-014 Stage 25).
///
/// INVARIANTS:
...
/// - Live ESP presented, still absent →
