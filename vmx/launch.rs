...
/// Stage 27 may flip this when a private guest-UEFI path can read real
...
/// Guest UEFI VMLAUNCH from ESP `\\EFI\\RayNu\\OVMF.fd` (ADR-014 Stage 26).
///
/// INVARIANTS:
...
/// - Live ESP admitted, still absent →
