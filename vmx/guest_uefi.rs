...
/// (iron `38481d9` same `pde8000=0x800000ff`). 4G paints 2–4GiB WB until
/// firmware programs the UC pair (`guest_uefi_mtrr_uc_hole_live`), then
/// [`identity_set_pat_uc_hole`].
