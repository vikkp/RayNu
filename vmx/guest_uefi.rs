...
/// Call on virtio MMIO and VMX preempt, not HLT (login: waits for COM1).
...
/// HLT after DRIVER_OK keeps UART ahead of PIT so auto-answer is not starved.
...
pub fn guest_uefi_linux_hlt_uart_after_driver_ok(
    ...
    linux && product_iso && !need_until_driver_ok
}
