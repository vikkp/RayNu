...
/// leftover (EntryPoint never returned). Keep PEI i440FX `0x1237` /
/// DXE virtio `0x1042`. Keep FIX WB hold. No DID flip. No new PAT-UC.
...
/// (`retcmp=`) plus `rbx`/`rsi`/`rdi` for the cmp. Keep DID and FIX WB
/// hold. No new PAT-UC.
