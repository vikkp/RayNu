...
/// the 2 MiB leaf; iron `maxpa=32` still splits. Iron COM2 `84171aa`:
/// GPA0 4K ran (`pde0=0x20b027` `pte0=0x67`) and still ASSERT — not
/// sufficient alone.
