...
/// Not `ISO-INSTALL-OK`.
pub fn guest_uefi_virtio_mmio_heartbeat_kick(n: u32, off: u16, overlay: bool) -> bool {
    guest_uefi_virtio_mmio_heartbeat(n) || (overlay && (off == 0x100 || off == 0x300))
}
...
unsafe fn handle_virtio_bar_ept(gpa: u64, qual: u64) -> bool {
    ...
    if guest_uefi_virtio_mmio_heartbeat_kick(n, (gpa.wrapping_sub(bar)) as u16, overlay) {
