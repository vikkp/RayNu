...
pub fn guest_uefi_firmware_skip_pit_inject(linux: bool, vec: u32) -> bool {
    guest_uefi_firmware_hlt_skip_without_inject(linux) && vec == 0x20
}
...
unsafe fn try_inject_guest_irq() {
    ...
    let lapic = if prefer_ata && crate::devices::lapic_virt::has_irr_vec(0x2E) {
        true
    ...
    let Some(vec) = (if use_pic {
        ...
        crate::devices::lapic_virt::take_irr_vec(0x2E, true).or_else(|| {
