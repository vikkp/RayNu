...
/// catalog+load READs. 131072 keeps the private VMCS until `RN-ELT` or the
/// hard cap. Stage 45 does not apply the 32768 post-ATAPI tail after PACKET.
...
/// BDS catalog + FatDxe + StartImage needs the 131072-exit cap.
...
///   needs the 131072-exit cap). `atapi_at` / catalog / boot_image are
