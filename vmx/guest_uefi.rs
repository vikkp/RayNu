...
/// nested iso=0 firmware IdeBus PCI cmd mask: store IO|MASTER only
/// (`0x0005`). EnableAttributes `0x0007` MSE is hardwired 0 on PIIX/QEMU.
/// CI `33491808360` VMXON-SKIP (`6fa77d1` ISA BAR unproven).
/// do not F11 6fa77d1. Not `ISO-INSTALL-OK`.
