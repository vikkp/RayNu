...
/// (iron `115e5ee` every-256 UART ticks split `Linux version` / PAT). Not
/// `ISO-INSTALL-OK`.
...
unsafe fn emit_guest_uart_byte(b: u8) {
    ...
    // at PAT after blocking THR wait on this tee.
