...
/// Raise PIT on Linux product-ISO resume after virtio probe or overlay
/// DRIVER_OK. `idle=poll` never HLT. linux PIT raise on overlay resume.
/// Not `ISO-INSTALL-OK`.
