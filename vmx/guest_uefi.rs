...
/// PML4 at [`GUEST_UEFI_MEMFD_BASE`] (`build_identity_4g`). VPID is off.
#[cfg(target_os = "uefi")]
unsafe fn handle_pf(rip: u64, linear: u64, cr2: u64) -> bool {
    ...
    let mut used = cr3;
    let mut r = crate::vmx::guest_pt::identity_map_not_present(
        used,
        cr2,
        ram_hpa,
        GUEST_UEFI_LOW_RAM_BYTES,
    );
    if matches!(r, Err(crate::vmx::guest_pt::IdentityMapError::NeedAlloc)) && used != sec {
