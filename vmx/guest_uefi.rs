...
/// - CPUID / RDMSR / WRMSR use [`crate::devices::guest_platform::HPET_INSN_STEP`] (~1ms)
/// - PCI config I/O and other exits stay 0
///
/// VERIFICATION: L1 (host tests)
pub fn guest_uefi_hpet_step_for_exit(basic: u32, hpet_ept: bool, acpi_io: bool) -> u64 {
    ...
    } else if basic == CPUID || basic == MSR_READ || basic == MSR_WRITE {
