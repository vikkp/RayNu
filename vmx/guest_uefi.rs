...
/// do not F11 489d938. firmware ATA over PIC. Not `ISO-INSTALL-OK`.
...
unsafe fn try_inject_guest_irq() {
    ...
    if guest_uefi_firmware_skip_pit_inject(linux, vec) {
        ...
        // firmware ATA over PIC. do not F11 489d938. do not F11 e70a295.
        // Not ISO-INSTALL-OK.
        let _ = set_guest_uefi_interrupt_window(false);
        return;
    }
