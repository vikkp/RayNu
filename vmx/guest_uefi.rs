...
/// flash eaa580d. flash 12926eb. do not F11 eaa580d. do not F11 bce5bbb. do not F11 489d938. firmware ATA over PIC. Not `ISO-INSTALL-OK`.
...
unsafe fn try_inject_guest_irq() {
    ...
    if guest_uefi_firmware_skip_pit_inject(linux, vec) {
        ...
        // firmware prefer ATA IRR. firmware ATA over PIC. do not F11 eaa580d.
        // do not F11 bce5bbb.
