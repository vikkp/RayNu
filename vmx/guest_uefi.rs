...
/// product ISO firmware HLT wake IDT 0x20 only. firmware skip PIT inject.
/// CI `33454767329` VMXON-SKIP. Not `ISO-INSTALL-OK`.
#[cfg(target_os = "uefi")]
unsafe fn try_inject_product_firmware_hlt_wake(
    ...
    // 0x27 and do not take_highest_irr (virtio can steal). Iron ea30da1.
    // CI 33454767329 VMXON-SKIP. Do not F11 d454545 / --run 33454767329.
