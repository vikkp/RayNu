...
/// `0x20`. `wait_for_irq` stays false. Nested path unchanged.
/// product ISO firmware HLT wake. firmware skip PIT inject.
/// Not `ISO-INSTALL-OK`.
#[cfg(target_os = "uefi")]
