...
unsafe fn try_inject_nested_iso0_firmware_hlt_pit(reason: u32) {
    ...
    let Some(vec) = crate::devices::guest_irq::take_nested_iso0_pit() else {
        let _ = set_guest_uefi_interrupt_window(false);
        return;
    };
