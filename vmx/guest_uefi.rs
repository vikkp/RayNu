            ...
            EXIT_REASON_HLT => {
                ...
                if hlt_should_resume() {
                            ...
                            .is_ok()
                    {
                        ...
                        // Iron COM2 c144001: EnableAttributes pcicmd=0x5,
                        // seq all zero, still ataio=0. COMMAND is closed.
                        // Print last CF8 so Connect park BDF is visible
                        // (stop line already has cf8=; HLT stall did not).
