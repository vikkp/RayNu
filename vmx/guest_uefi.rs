...
/// ([`guest_uefi_firmware_hlt_skip_only_after_inject`]). Cap stays
/// [`guest_uefi_firmware_hlt_inject_cap`]. `wait_for_irq` stays false.
/// nested iso=0 firmware HLT skip after inject.
