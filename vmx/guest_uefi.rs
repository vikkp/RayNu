...
/// in the 32 MiB slab. VPID is off, so VMRESUME flushes the guest TLB.
#[cfg(target_os = "uefi")]
unsafe fn handle_pf(rip: u64, linear: u64, cr2: u64) -> bool {
    ...
    match crate::vmx::guest_pt::identity_map_not_present(
        cr3,
        cr2,
        ram_hpa,
