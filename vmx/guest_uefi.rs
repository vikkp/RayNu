...
unsafe fn try_inject_nested_iso0_firmware_hlt_pit(reason: u32) {
    ...
    // firmware HLT inject cap: CI 33466890874 logged 8x 0x68 then kept
    // injecting (print-only cap). nested iso=0 firmware HLT 0x68 miss.
