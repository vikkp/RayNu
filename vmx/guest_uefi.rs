...
/// Drain after ISR ACK so a sibling ISO used-idx is not missed.
...
/// Iron `e717fb4` / `34220740109`: same apk `n=1345` freeze. virtio stall dump.
/// Not `ISO-INSTALL-OK`.
...
unsafe fn handle_virtio_bar_ept(gpa: u64, qual: u64) -> bool {
    ...
    if guest_uefi_virtio_mmio_heartbeat(n) {
