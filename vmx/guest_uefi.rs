...
/// Linux 8259 slave ICW2 0x28 + IRQ 11. linux virtio PIC 11.
/// Not `ISO-INSTALL-OK`.
pub fn guest_uefi_linux_virtio_pic_vec(vec: u32) -> bool {
    vec == 0x28 + u32::from(crate::devices::guest_irq::VIRTIO_PIC_IRQ) - 8
}
