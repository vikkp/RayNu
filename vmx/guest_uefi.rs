    ...
    if guest_uefi_pf_should_load_sec_cr3(cr3) {
        ...
        match r {
            ...
            Err(crate::vmx::guest_pt::IdentityMapError::AlreadyPresent) => {
                r = Ok(crate::vmx::guest_pt::IdentityMapKind::Cr3Sec);
            }
            Err(crate::vmx::guest_pt::IdentityMapError::NeedAlloc) => {
                match crate::vmx::guest_pt::build_identity_4g(
                    ram_hpa,
                    GUEST_UEFI_LOW_RAM_BYTES,
                    sec,
                ) {
                    Ok(_) => r = Ok(crate::vmx::guest_pt::IdentityMapKind::Cr3Sec),
                    Err(e) => r = Err(e),
                }
            }
            Err(_) => {}
        ...
        if matches!(r, Err(crate::vmx::guest_pt::IdentityMapError::NeedAlloc)) {
            match crate::vmx::guest_pt::build_identity_4g(ram_hpa, GUEST_UEFI_LOW_RAM_BYTES, sec)
            {
                Ok(_) => {
                    used = sec;
                    r = Ok(crate::vmx::guest_pt::IdentityMapKind::Cr3Sec);
