    ...
    let Some(op) = crate::devices::guest_virtio_blk::decode_mmio_insn(&buf[..n], insn_len as usize)
        ...
        if virtio_mmio_eax_fallback(
            ...
            if is_write {
                ...
                let mem = crate::devices::guest_virtio_blk::mmio_read_at(gpa, 4);
                set_cr_gpr(0, mem);
            }
            return skip_insn();
        }
