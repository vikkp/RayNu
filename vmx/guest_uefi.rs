...
unsafe fn launch_uefi(
    ...
    if crate::devices::guest_platform::e820_splits_vga_below_1m() {
        serial::write_line("boot: guest-UEFI e820 VGA hole 640K-1M (GCD)");
    }
