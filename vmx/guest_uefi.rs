...
/// - Unpatched leftover below [`GUEST_UEFI_CPU_FLUSH_HEAP_GPA`] is skipped
///   (empty no-zero DRAM; iron `f0eb84e` `ram=1008`)
/// - Heap GPA is scanned until patched (iron `d6b012a` `0x7EE68FA0`)
///
...
unsafe fn guest_uefi_patch_cpu_flush_all_mapped() {
    // cpu_flush skip leftover pre-map: iron `f0eb84e` walked ~2GiB.
