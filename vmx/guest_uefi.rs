...
/// flash eaa580d. do not F11 bce5bbb. do not F11 489d938. firmware ATA over PIC. Not `ISO-INSTALL-OK`.
...
unsafe fn try_inject_guest_irq() {
    ...
    if guest_uefi_firmware_skip_pit_inject(linux, vec) {
        ...
        // flash 5227ad9. flash 489d938. flash bce5bbb. flash eaa580d.
        // firmware prefer ATA IRR. firmware ATA over PIC. do not F11 bce5bbb.
