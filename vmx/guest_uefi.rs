...
/// CpuSleep `[RSP]` return address. Iron COM2 `27eda8c` hide-slot0
/// still `rip=0x7f0680d0` `ataio=0`. print HLT retaddr.
...
/// address. Iron COM2 `27eda8c` still `rip=0x7f0680d0`. print HLT retaddr.
#[cfg(target_os = "uefi")]
