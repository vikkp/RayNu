...
/// firmware prefer ATA IRR. flash 489d938. Not `ISO-INSTALL-OK`.
...
unsafe fn try_inject_guest_irq() {
    ...
    if guest_uefi_firmware_skip_pit_inject(linux, vec) {
        ...
        // flash 5227ad9. flash 489d938. firmware prefer ATA IRR.
        // do not F11 e70a295. Not ISO-INSTALL-OK.
        let _ = set_guest_uefi_interrupt_window(false);
        return;
    }
