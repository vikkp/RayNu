...
/// nested iso=0 firmware IdeBus PCI cmd QEMU: QEMU `pci_init_wmask` is
/// IO|MEM|MASTER (`0x0007`). ICH `0x0005` dropped MSE so EnableAttributes
/// `0x0007` readback failed before ISA `0x3F6`. CI `33508115698`
/// VMXON-SKIP (`edf0682` slot0 fn1 unproven). do not F11 edf0682.
/// Not `ISO-INSTALL-OK`.
