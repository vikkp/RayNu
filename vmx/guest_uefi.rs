...
/// - CPUID / RDMSR / WRMSR / non-HPET EPT / UART COM I/O use [`crate::devices::guest_platform::HPET_INSN_STEP`] (~1ms)
/// - PCI config and ATA I/O stay 0
///
/// VERIFICATION: L1 (host tests)
pub fn guest_uefi_hpet_step_for_exit(
    basic: u32,
    hpet_ept: bool,
    acpi_io: bool,
    uart_io: bool,
...
fn tick_hpet_on_exit(basic: u32, gpa: u64, qual: u64) {
    ...
    {
        serial::write_line(
            "boot: guest-UEFI UART HPET 1ms step (Stage 46; not ISO-INSTALL-OK)",
        );
    }
