...
/// skipped. fw_cfg string skip HV identity dest. Not `ISO-INSTALL-OK`.
...
/// COM2 prefix when [`guest_uefi_io_string_dest_ok`] is false.
/// fw_cfg string skip HV identity dest. Not `ISO-INSTALL-OK`.
