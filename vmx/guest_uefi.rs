...
/// NP `#PF` in a sink GPA gets a UC 2 MiB leaf; EPT still sink-resumes.
pub fn guest_uefi_pf_should_map_mmio(err: u64, cr2: u64) -> bool {
    guest_uefi_pf_error_is_not_present(err)
