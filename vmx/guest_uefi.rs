...
unsafe fn handle_pf(rip: u64, linear: u64, cr2: u64) -> bool {
    ...
    {
        // linux earlycon hush HV before the long #PF dump so it does not
        // block THRE or enqueue into the guest printk FIFO (iron 9a3cbfa).
        serial::set_linux_earlycon_share(true);
    }
