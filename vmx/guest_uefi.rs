...
/// Product ATA: PIC IRQ 14 take, else EDK2 `0x76` (not leftover `0x2E`).
...
unsafe fn try_inject_product_firmware_hlt_ata(
    ...
    let vec = guest_uefi_product_firmware_hlt_ata_inject_vec(pic);
