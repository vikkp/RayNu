...
**Through M6.4 wired** (AUTH → `RAYNU-V-M6-AUTH-OK`; Latitude pending). Next after close: **M6.5** (PDF → `RAYNU-V-M6-PDF-OK`). Lived: [docs/progress.md](docs/progress.md). Plan: [docs/m6_plan.md](docs/m6_plan.md).
