...
**Through M7.0 closed** (SHIP → `RAYNU-V-M7-SHIP-OK`). Next: **M7.1 HTTP**. Plan: [docs/m7_plan.md](docs/m7_plan.md). HDA: [docs/hda.md](docs/hda.md). Lived: [docs/progress.md](docs/progress.md).
