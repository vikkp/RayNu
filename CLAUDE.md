...
**Through M3.22 closed** (PE assets → `RAYNU-V-M3-ASSETS-OK`). Next: **M4.0** (2VM). Lived: [docs/progress.md](docs/progress.md). Plan: [docs/m4_plan.md](docs/m4_plan.md) (prior: [docs/m3_post_shell_plan.md](docs/m3_post_shell_plan.md)).
