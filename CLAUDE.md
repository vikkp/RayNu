...
**Through M7.4 closed** (UI → `RAYNU-V-M7-UI-OK` host smoke; console/TLS/NIC residual). **M7.5 scaffolded** (`RAYNU-V-M7-R640-SCAFFOLD-OK`); iron `RAYNU-V-R640-BOOT-OK` open. Plan: [docs/m7_plan.md](docs/m7_plan.md). HDA: [docs/hda.md](docs/hda.md). Lived: [docs/progress.md](docs/progress.md).
