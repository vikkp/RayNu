...
**Through M3.14 closed**; **M3.15 in progress** (pin Verus → `RAYNU-V-M3-VERUS-OK`). True L3: M3.15→M3.17. Lived: [docs/progress.md](docs/progress.md). Post-shell: [docs/m3_post_shell_plan.md](docs/m3_post_shell_plan.md).
