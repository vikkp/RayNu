...
**Through M6.3 wired** (migrate-xfer → `RAYNU-V-M6-MIGRATE-XFER-OK`; Latitude pending). Next after close: **M6.4** (AUTH → `RAYNU-V-M6-AUTH-OK`). Lived: [docs/progress.md](docs/progress.md). Plan: [docs/m6_plan.md](docs/m6_plan.md).
