...
**Through M6.9 wired** (external → `RAYNU-V-M6-EXT-OK`; Latitude pending). Next after close: **M6 closed**. Lived: [docs/progress.md](docs/progress.md). Plan: [docs/m6_plan.md](docs/m6_plan.md).
