...
**Through M6.7 wired** (fault → `RAYNU-V-M6-FAULT-OK`; Latitude pending). Next after close: **M6.8** (soak → `RAYNU-V-M6-SOAK-OK`). Lived: [docs/progress.md](docs/progress.md). Plan: [docs/m6_plan.md](docs/m6_plan.md).
