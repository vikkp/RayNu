...
**Through M6.1 closed** (HW PTE → `RAYNU-V-M6-HWPTE-OK`). Active: **M6.2** (NUMA-L3 → `RAYNU-V-M6-NUMA-L3-OK`). Lived: [docs/progress.md](docs/progress.md). Plan: [docs/m6_plan.md](docs/m6_plan.md).
