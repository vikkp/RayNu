...
**Through M7.4 closed** (UI → `RAYNU-V-M7-UI-OK` host smoke; console/TLS/NIC residual). Next: **M7.5 R640**. Plan: [docs/m7_plan.md](docs/m7_plan.md). HDA: [docs/hda.md](docs/hda.md). Lived: [docs/progress.md](docs/progress.md).
