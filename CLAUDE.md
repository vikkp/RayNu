...
**Through M6.5 wired** (PDF → `RAYNU-V-M6-PDF-OK`; Latitude pending). Next after close: **M6.6** (HA → `RAYNU-V-M6-HA-OK`). Lived: [docs/progress.md](docs/progress.md). Plan: [docs/m6_plan.md](docs/m6_plan.md).
