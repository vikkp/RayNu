...
**Through M6.7 closed** (fault → `RAYNU-V-M6-FAULT-OK`). Active: **M6.8** (soak → `RAYNU-V-M6-SOAK-OK`). Lived: [docs/progress.md](docs/progress.md). Plan: [docs/m6_plan.md](docs/m6_plan.md).
