...
**Through M5.5 closed** (VMware import → `RAYNU-V-M5-MIGRATE-OK`). Active: **M5.7** host wiring (large-page L3 → `RAYNU-V-M5-LPAGE-VERIFY-OK`, Latitude pending); M5.6 parallel. Lived: [docs/progress.md](docs/progress.md). Plan: [docs/m5_plan.md](docs/m5_plan.md).
