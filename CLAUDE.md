...
**Through M7.2 wired** (STORE → `RAYNU-V-M7-STORE-OK`; Latitude pending). Next after close: **M7.3 ISO**. Plan: [docs/m7_plan.md](docs/m7_plan.md). HDA: [docs/hda.md](docs/hda.md). Lived: [docs/progress.md](docs/progress.md).
