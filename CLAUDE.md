...
**Through M6.6 wired** (HA → `RAYNU-V-M6-HA-OK`; Latitude pending). Next after close: **M6.7** (fault → `RAYNU-V-M6-FAULT-OK`). Lived: [docs/progress.md](docs/progress.md). Plan: [docs/m6_plan.md](docs/m6_plan.md).
