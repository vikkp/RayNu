...
**Through M7.0 wired** (ship kit → `RAYNU-V-M7-SHIP-OK`; Latitude pending). Next after close: **M7.1 HTTP**. Plan: [docs/m7_plan.md](docs/m7_plan.md). HDA: [docs/hda.md](docs/hda.md). Lived: [docs/progress.md](docs/progress.md).
