...
**Through M6.2 wired** (NUMA-L3 → `RAYNU-V-M6-NUMA-L3-OK`; Latitude pending). Next after close: **M6.3** (migrate-xfer → `RAYNU-V-M6-MIGRATE-XFER-OK`). Lived: [docs/progress.md](docs/progress.md). Plan: [docs/m6_plan.md](docs/m6_plan.md).
