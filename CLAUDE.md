...
**Through M4.9 closed** (N-guest refine → `RAYNU-V-M4-REFINE-OK`). M4 Track A–C complete. Active: **M5**. Lived: [docs/progress.md](docs/progress.md). Plan: [docs/m4_plan.md](docs/m4_plan.md) (prior: [docs/m3_post_shell_plan.md](docs/m3_post_shell_plan.md)).
