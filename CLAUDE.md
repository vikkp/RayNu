...
| 013   | Management Network Architecture        | Native NIC + smoltcp for lifetime HTTP (E3b); SNP bring-up only; Phase D closed post-`VMXOFF`; Stage 1 = coexist + iron E + F; `:38` lab default not a hard-coded product MAC (Phase G); **Accepted** |
