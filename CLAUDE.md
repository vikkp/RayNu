...
**Through M3.7 closed** on Latitude (`RAYNU-V-M3-BZIMAGE-OK`). **M3.8 in flight**: real Linux earlyprintk (`RAYNU-V-M3-LINUX-EARLY-OK`). Plan: [docs/m3_plan.md](docs/m3_plan.md).
