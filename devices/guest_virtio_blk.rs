...
/// Decode MOV/MOVZX/MOVSX/XCHG/ALU RMW (mem or dest-reg)/TEST/CMP/INC/DEC/NOT/NEG/BT family that OVMF IoLib and Linux ioread use for virtio-pci BAR and xAPIC MMIO.
