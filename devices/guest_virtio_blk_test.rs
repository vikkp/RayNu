...
fn decode_mmio_mov_encodings() {
    ...
    assert!(decode_mmio_insn(&[0xFF, 0x10], 2).is_none());
    assert!(decode_mmio_insn(&[0xFF, 0x20], 2).is_none());
    ...
    assert!(decode_mmio_insn(&[0xA6], 1).is_none());
    assert!(decode_mmio_insn(&[0xAE], 1).is_none());
