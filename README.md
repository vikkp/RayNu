...
**M0 → M3.20 closed**; **M3.21 open** — hard-fail Kani CI → `RAYNU-V-M3-KANI-OK` (awaiting CI/Latitude). Lived: [docs/progress.md](docs/progress.md). Plan: [docs/m3_post_shell_plan.md](docs/m3_post_shell_plan.md).
