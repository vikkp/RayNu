...
**M0 → M4.2 closed** — ≥4 concurrent guests under EPT → `RAYNU-V-M4-NVM-OK`. Active: **M4.3** (virtio-blk MMIO probe) — [docs/m4_plan.md](docs/m4_plan.md). Lived: [docs/progress.md](docs/progress.md).
