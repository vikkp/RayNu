...
**M0 → M4.8 closed** — large-page ghost spec → `RAYNU-V-M4-LPAGE-OK`. Active: **M4.9** (N-guest refine) — [docs/m4_plan.md](docs/m4_plan.md). Lived: [docs/progress.md](docs/progress.md).
