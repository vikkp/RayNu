...
**M0 → M3.0 closed** — Latitude boot gate through guest COM1 I/O (`RAYNU-V-M3-IO-OK`); M2.6 L2 host gate closed. Plan: [docs/m3_plan.md](docs/m3_plan.md). Next: M3.1 CPUID filter.
