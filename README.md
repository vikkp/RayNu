...
**Iron:** Real R640 COM2 shows **M0 → EBS → VMXON → LOAD → BZIMAGE** (2026-08-15). **`RAYNU-V-R640-BOOT-OK` still open** (VMLAUNCH/guest residual; `releases/v0.1.0-barfix/`). Evidence: [docs/evidence/r640/2026-08-15-r640-first-light.md](docs/evidence/r640/2026-08-15-r640-first-light.md).
