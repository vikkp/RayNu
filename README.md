...
**Iron:** Real R640 **M0 first light** (`RAYNU-V-M0-BOOT-OK`, 2026-08-15 via iDRAC vMedia). **`RAYNU-V-R640-BOOT-OK` still open** (post-M0 SOL residual). Lived: [docs/progress.md](docs/progress.md) · evidence: [docs/evidence/r640/2026-08-15-r640-first-light.md](docs/evidence/r640/2026-08-15-r640-first-light.md).
