...
**Next:** **M7.4 UI** (M7.3 ISO closed on Latitude host smoke — `RAYNU-V-M7-ISO-OK`; El Torito residual). Lived: [docs/progress.md](docs/progress.md). Plan: [docs/m7_plan.md](docs/m7_plan.md).
