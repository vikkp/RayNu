...
**Iron:** Real R640 COM2 closed **`RAYNU-V-R640-BOOT-OK`** (2026-08-15) and **`RAYNU-V-M7-UEFI-HTTP-OK`** / **`RAYNU-V-M7-ISO-BOOTED-FROM-DISK`** (2026-08-16). WARN-only post-EBS SNP idle closed 2026-08-17 (**no RSOD**). ADR-013 Phase 0 census closed 2026-08-17: **`14e4:165f`** BCM5720 dual-port. Phase D binds the **SNP-lease MAC** (R640: `01:00.1` / `:5a:3a`); bring-up follows Linux **`tg3`** (not `bnxt`) — **`RAYNU-V-M7-HOST-NIC-HTTP-OK` not claimed** until an iron exchange after `BOOT-OK`. Preserve: [`releases/v0.1.0-adr013-baseline/`](releases/v0.1.0-adr013-baseline/).
