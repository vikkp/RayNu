...
echo "  boot: uefi-net extra nii=… pxe=… http=… ip4cfg=… drv=…"
...
echo "  boot: uefi-net connect stack_ok=… all_ok=…           # SB + bounded all-handles"
echo "  boot: uefi-net after-all … extra-after …             # Tcp4 still 0 → SNP residual"
