...
pub fn r640_scripts_present() -> bool {
    ...
    smoke.contains(M7_R640_SCAFFOLD_MARKER)
        ...
        && include_str!("../docs/runbooks/r640_cruzer_flash.md").contains("raynuvsrv1")
        && include_str!("../docs/runbooks/r640_cruzer_flash.md").contains("LABEL=RAYNUV")
        && include_str!("../docs/runbooks/r640_cruzer_flash.md").contains("installdisk.bin")
        && include_str!("../tools/flash-cruzer-esp.sh").contains("target_is_lab_cruzer")
        && include_str!("../tools/flash-cruzer-esp.sh").contains("/dev/disk/by-label/")
        && include_str!("../tools/flash-cruzer-esp.sh").contains("RAYNU-V-CRUZER-FLASH-OK")
        && !include_str!("../tools/flash-cruzer-esp.sh").contains("dd if=")
        && include_str!("../docs/evidence/r640/2026-08-19-raynuvsrv1-cruzer.md")
            .contains("0781:5151")
