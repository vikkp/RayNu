use super::{
    ...
    ovmf_live_esp_is_mapped, ovmf_real_esp_is_qualified, ovmf_real_launch_is_armed,
    ovmf_reset_vector_is_armed, ovmf_slot_is_armed, parse_guest_fw, prepare_ovmf_firmware_launch,
    probe_ovmf_firmware, program_ovmf_alias_ept, qualify_real_esp_ovmf, reset_guest_fw,
