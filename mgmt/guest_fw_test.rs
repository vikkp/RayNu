use super::{
    ...
    ovmf_live_esp_is_mapped, ovmf_live_esp_is_required, ovmf_live_issue_is_armed,
    ...
    require_ovmf_live_esp, reset_guest_fw, stage_edk2_ovmf_firmware, stage_ovmf_firmware_floor,
