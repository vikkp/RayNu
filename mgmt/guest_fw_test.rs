use super::{
    ...
    guest_fw_is_boxed, guest_fw_is_loaded, guest_fw_payload, install_ovmf_alias_ept,
    ...
    ovmf_live_esp_is_admitted, ovmf_live_esp_is_mapped, ovmf_live_esp_is_presented,
