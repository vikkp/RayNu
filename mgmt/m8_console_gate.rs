...
pub fn console_surface_present() -> bool {
    ...
    console.contains("enum ConsoleMode")
        ...
        && include_str!("../vmx/guest_uefi.rs")
            .contains("RayNu-F SOL RX to guest COM1 (GRUB serial)")
        && include_str!("../vmx/guest_uefi.rs").contains("RayNu-F GRUB 16550 not stub LSR")
        ...
        && include_str!("../assets/webui.html").contains("listBusy")
