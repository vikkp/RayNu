...
pub fn ovmf_atapi_surface_present() -> bool {
    ...
    attach_cdrom_uefi(1) == Err(IsoError::UnsupportedOnFirmware)
        ...
        && guest.contains("nested iso=0 firmware IdeBus cfg write")
        && guest.contains("fn guest_uefi_nested_iso0_firmware_idebus_cfg_write")
        && guest.contains("nested iso=0 firmware IdeBus CF8")
        && guest.contains("fn guest_uefi_nested_iso0_firmware_idebus_cf8")
        && guest.contains("nested iso=0 firmware IdeBus CF8E")
        && guest.contains("fn guest_uefi_nested_iso0_firmware_idebus_cf8e")
        && guest.contains("nested iso=0 firmware IdeBus IO aperture")
        && guest.contains("fn guest_uefi_nested_iso0_firmware_idebus_io_aperture")
        ...
        && include_str!("../devices/ide_cdrom.rs").contains("nested iso=0 firmware IdeBus cfg write")
        && include_str!("../devices/ide_cdrom.rs").contains("nested iso=0 firmware IdeBus CF8")
        && include_str!("../devices/ide_cdrom.rs").contains("nested iso=0 firmware IdeBus CF8E")
        && include_str!("../devices/ide_cdrom.rs").contains("nested iso=0 firmware IdeBus IO aperture")
...
pub fn run_m7_e5_ovmf_atapi_gate() -> bool {
    ...
    let ok = ovmf_atapi_surface_present()
        ...
        && E5_OVMF_VMLAUNCH_RESIDUAL_NOTE.contains("nested iso=0 firmware IdeBus cfg write")
        && E5_OVMF_VMLAUNCH_RESIDUAL_NOTE.contains("33536269880")
        && E5_OVMF_VMLAUNCH_RESIDUAL_NOTE.contains("do not F11 004ef9b")
        && E5_OVMF_VMLAUNCH_RESIDUAL_NOTE.contains("cfgw=")
        && E5_OVMF_VMLAUNCH_RESIDUAL_NOTE.contains("nested iso=0 firmware IdeBus CF8")
        && E5_OVMF_VMLAUNCH_RESIDUAL_NOTE.contains("33537641723")
        && E5_OVMF_VMLAUNCH_RESIDUAL_NOTE.contains("do not F11 30ccfc0")
        && E5_OVMF_VMLAUNCH_RESIDUAL_NOTE.contains("cf8s=")
        && E5_OVMF_VMLAUNCH_RESIDUAL_NOTE.contains("nested iso=0 firmware IdeBus CF8E")
        && E5_OVMF_VMLAUNCH_RESIDUAL_NOTE.contains("33539999700")
        && E5_OVMF_VMLAUNCH_RESIDUAL_NOTE.contains("do not F11 02e8843")
        && E5_OVMF_VMLAUNCH_RESIDUAL_NOTE.contains("cf8e=")
        && E5_OVMF_VMLAUNCH_RESIDUAL_NOTE.contains("nested iso=0 firmware IdeBus IO aperture")
        && E5_OVMF_VMLAUNCH_RESIDUAL_NOTE.contains("33541472361")
        && E5_OVMF_VMLAUNCH_RESIDUAL_NOTE.contains("do not F11 a50ad99")
        && E5_OVMF_VMLAUNCH_RESIDUAL_NOTE.contains("iobase=")
