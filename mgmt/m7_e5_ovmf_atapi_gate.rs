...
pub fn ovmf_atapi_surface_present() -> bool {
    ...
    attach_cdrom_uefi(1) == Err(IsoError::UnsupportedOnFirmware)
        ...
        && guest.contains("fn linux_prefer_pit_during_apk")
        && guest.contains("fn guest_uefi_linux_prefer_pit_during_apk")
        && guest.contains("linux PIT once after DRIVER_OK")
        && guest.contains("fn guest_uefi_linux_hlt_prefer_pit_during_apk")
        && guest.contains("linux HLT PIT during apk")
        && guest.contains("fn guest_uefi_linux_uart_prefer_pit_during_apk")
        && guest.contains("linux UART PIT during apk")
        && guest.contains("linux PIT after DRIVER_OK until login")
        && guest.contains("fn guest_uefi_linux_hlt_uart_after_driver_ok")
        && guest.contains("linux HLT UART after DRIVER_OK")
        && guest.contains("fn guest_uefi_linux_prefer_pit_hold")
        ...
        && guest.contains("fn guest_uefi_linux_pit_resume_elapsed")
        && guest.contains("fn guest_uefi_linux_raise_pit_on_resume_due")
        && guest.contains("linux PIT resume paced")
        && guest.contains("linux PIT resume min tsc")
        && guest.contains("fn guest_uefi_linux_pic_before_leftover_gsi2")
        && guest.contains("linux PIC before leftover GSI 2")
        && guest.contains("fn guest_uefi_linux_reassert_virtio_intx")
        && guest.contains("linux virtio INTx reassert")
        && guest.contains("fn guest_uefi_linux_virtio_pic_vec")
        && guest.contains("linux virtio PIC 11")
        ...
        && guest.contains("linux PIC IRQ11 yield until mount")
        && guest.contains("linux PIC IRQ11 yield 3 after mount")
        && guest.contains("virtio drain FLUSH")
        && guest.contains("virtio chain all segs")
        && guest.contains("virtio used idx")
        && guest.contains("virtio drain on ISR")
        && guest.contains("virtio stall dump")
        && guest.contains("virtio GET_ID")
        && guest.contains("virtio shared INTx hold")
        && guest.contains("virtio stall dump again")
        && guest.contains("virtio MMIO heartbeat kick")
        && guest.contains("virtio stall dump PIT")
        && guest.contains("virtio stall dump INTx")
        && guest.contains("virtio stall dump notify reset")
        && guest.contains("virtio stall dump PIT hold")
        && guest.contains("virtio stall dump PIT paced")
        && guest.contains("virtio stall dump ring")
        && guest.contains("virtio stall probe")
        ...
        && include_str!("../devices/guest_virtio_blk.rs").contains("virtio used idx")
        && include_str!("../devices/guest_virtio_blk.rs").contains("virtio GET_ID")
        && include_str!("../devices/guest_irq.rs").contains("linux PIC IRQ11 yield PIT")
        && include_str!("../devices/guest_irq.rs").contains("linux PIC IRQ11 yield until mount")
        && include_str!("../devices/guest_irq.rs").contains("linux PIC IRQ11 yield 3 after mount")
        ...
        && guest.contains("fn guest_uefi_linux_virtio_mmio_raises_pit")
        && guest.contains("linux virtio MMIO PIT until DRIVER_OK")
        && include_str!("../devices/guest_virtio_blk.rs").contains("fn virtio_isr_latched")
        && include_str!("../devices/guest_virtio_blk.rs").contains("fn reassert_virtio_shared_intx")
        && include_str!("../devices/guest_virtio_blk.rs").contains("virtio shared INTx")
        && include_str!("../devices/guest_virtio_blk.rs").contains("virtio shared INTx hold")
        && include_str!("../devices/guest_virtio_blk.rs").contains("fn virtio_live_avail_idx")
        && include_str!("../vmx/guest_uefi.rs").contains("virtio stall dump again")
        && include_str!("../vmx/guest_uefi.rs").contains("virtio MMIO heartbeat kick")
        && include_str!("../vmx/guest_uefi.rs").contains("virtio stall dump PIT")
        && include_str!("../vmx/guest_uefi.rs").contains("virtio stall dump INTx")
        && include_str!("../vmx/guest_uefi.rs").contains("virtio stall dump notify reset")
        ...
        && include_str!("../vmx/guest_uefi.rs").contains("fn guest_uefi_virtio_stall_probe")
        && include_str!("../devices/guest_virtio_blk.rs").contains("fn virtio_ring_live")
        && include_str!("../devices/guest_virtio_blk.rs").contains("fn virtio_xlate_fail_count")
        && include_str!("../devices/guest_uart.rs").contains("fn inject_sysrq")
        && include_str!("../devices/guest_uart.rs").contains("UART sysrq break")
        && include_str!("iso_install.rs").contains("sysrq_always_enabled")
        && include_str!("../devices/guest_virtio_blk.rs").contains("fn virtio_stall_pulse_intx")
        ...
        && include_str!("../devices/guest_virtio_blk.rs").contains("fn virtio_linux_probe_started")
        && include_str!("../devices/guest_virtio_blk.rs").contains("fn virtio_both_driver_ok")
        && include_str!("../devices/guest_irq.rs").contains("fn prefer_pit_hold")
        ...
        && uart.contains("UART THRE chain telemetry")
        && uart.contains("fn thre_chain")
        && include_str!("../devices/guest_irq.rs").contains("fn pic_master_snap")
        && guest.contains("fn virtio_stall_dump_thre_chain")
        && include_str!("../src/lib.rs").contains("build sha banner")
        && include_str!("../boot/serial.rs").contains("guest UART TX ring room")
        && include_str!("../boot/serial.rs").contains("fn guest_tx_room_has_thre")
        && include_str!("../boot/serial.rs").contains("guest UART COM2 FIFO burst")
        && include_str!("../boot/serial.rs").contains("fn iir_reports_fifo")
        && uart.contains("guest UART TX ring room")
        && guest.contains("guest UART line-rate pace")
        && guest.contains("fn arm_preempt_on_resume")
        && guest.contains("fn guest_uefi_preempt_arm")
        && guest.contains("virtio MMIO kick throttle")
        ...
        && include_str!("../devices/ide_cdrom.rs")
            .contains("fn product_iso_hides_duplicate_slot0_ide")
        && include_str!("../devices/ide_cdrom.rs")
            .contains("product ISO hides duplicate slot0 IDE")
...
pub fn run_m7_e5_ovmf_atapi_gate() -> bool {
    ...
    let ok = ovmf_atapi_surface_present()
        ...
        && E5_OVMF_VMLAUNCH_RESIDUAL_NOTE.contains("product ISO hides duplicate slot0 IDE")
        ...
        && E5_OVMF_VMLAUNCH_RESIDUAL_NOTE.contains("iron COM2 2d4ab51 HLT ret=0x7ff0e055 still ataio=0")
        && E5_OVMF_VMLAUNCH_RESIDUAL_NOTE.contains("do not F11 2d4ab51")
        && E5_OVMF_VMLAUNCH_RESIDUAL_NOTE.contains("firmware ConIn CR")
        && E5_OVMF_VMLAUNCH_RESIDUAL_NOTE.contains("iron COM2 6c4bfde ConIn CR still ataio=0")
        && E5_OVMF_VMLAUNCH_RESIDUAL_NOTE.contains("do not F11 6c4bfde")
        && E5_OVMF_VMLAUNCH_RESIDUAL_NOTE.contains("print HLT callsite")
        ...
        && E5_OVMF_VMLAUNCH_RESIDUAL_NOTE.contains("do not F11 c8d504d")
        ...
        && E5_OVMF_VMLAUNCH_RESIDUAL_NOTE.contains("linux PIT once after DRIVER_OK")
        && E5_OVMF_VMLAUNCH_RESIDUAL_NOTE.contains("linux HLT PIT during apk")
        && E5_OVMF_VMLAUNCH_RESIDUAL_NOTE.contains("linux PIT after DRIVER_OK until login")
        && E5_OVMF_VMLAUNCH_RESIDUAL_NOTE.contains("linux UART PIT during apk")
