...
use crate::mgmt::console::{
    firmware_console_is_serial_log_only, host_never_prints_iron_console_ok, M8_CONSOLE_HOST_OK_MARKER,
...
fn m8_console_host_gate_passes() {
    ...
    assert!(
        ...
        "M8.3 host console package must hold (not iron CONSOLE-OK)"
    );
